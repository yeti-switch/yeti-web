...
i_call_ctx switch22.call_ctx_ty,
i_diversion switch22.uri_ty[],
i_privacy character varying[],
i_pai switch22.uri_ty[],
i_ppi switch22.uri_ty)
...
CREATE or replace FUNCTION switch22.route(
i_node_id integer,
i_pop_id integer,
...
DROP FUNCTION switch22.process_gw(i_profile switch22.callprofile_ty, i_destination class4.destinations, i_dp class4.dialpeers,
i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_vendor_gw class4.gateways,
i_send_billing_information boolean, i_max_call_length integer, i_diversion switch22.uri_ty[], i_privacy character varying[],
i_pai switch22.uri_ty[], i_ppi switch22.uri_ty);

DROP FUNCTION switch22.process_gw_release(i_profile switch22.callprofile_ty, i_destination class4.destinations, i_dp class4.dialpeers,
i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_vendor_gw class4.gateways,
i_send_billing_information boolean, i_max_call_length integer, i_diversion switch22.uri_ty[], i_privacy character varying[],
i_pai switch22.uri_ty[],i_ppi switch22.uri_ty);

DROP FUNCTION switch22.process_gw_debug(i_profile switch22.callprofile_ty, i_destination class4.destinations, i_dp class4.dialpeers,
i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_vendor_gw class4.gateways,
i_send_billing_information boolean, i_max_call_length integer, i_diversion switch22.uri_ty[], i_privacy character varying[],
i_pai switch22.uri_ty[], i_ppi switch22.uri_ty);

CREATE OR REPLACE FUNCTION switch22.process_gw(
i_profile switch22.callprofile_ty,
i_destination class4.destinations,
i_dp class4.dialpeers,
i_customer_acc billing.accounts,
...
i_pai switch22.uri_ty[],
i_ppi switch22.uri_ty
) RETURNS switch22.callprofile_ty
...
DROP FUNCTION switch22.process_dp(
i_profile switch22.callprofile_ty,
i_destination class4.destinations,
i_dp class4.dialpeers,
i_customer_acc billing.accounts,
...
DROP FUNCTION switch22.process_dp_debug(
i_profile switch22.callprofile_ty,
i_destination class4.destinations,
i_dp class4.dialpeers,
i_customer_acc billing.accounts,
...
DROP FUNCTION switch22.process_dp_release(
i_profile switch22.callprofile_ty,
i_destination class4.destinations,
i_dp class4.dialpeers,
i_customer_acc billing.accounts,
...
DROP FUNCTION switch22.process_gw(
i_profile switch22.callprofile_ty,
i_destination class4.destinations,
i_dp class4.dialpeers,
i_customer_acc billing.accounts,
...
DROP FUNCTION switch22.process_gw_debug(
i_profile switch22.callprofile_ty,
i_destination class4.destinations,
i_dp class4.dialpeers,
i_customer_acc billing.accounts,
...
DROP FUNCTION switch22.process_gw_release(
i_profile switch22.callprofile_ty,
i_destination class4.destinations,
i_dp class4.dialpeers,
i_customer_acc billing.accounts,
...
$_$;
    ...
    set search_path TO gui, public, switch, billing, class4, runtime_stats, sys, logs, data_import;
      ...
      drop type switch22.call_ctx_ty;
