...
$_$;
      ...
      delete from switch20.switch_interface_out where name='bleg_force_cancel_routeset';
  ...
  def up
    execute %q{
      ...
      alter type switch20.callprofile_ty add attribute bleg_force_cancel_routeset boolean;
