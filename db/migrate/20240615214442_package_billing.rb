class PackageBilling < ActiveRecord::Migration[7.0]
  ...
  def up
    execute %q{
      ...
      alter type switch21.callprofile_ty add attribute package_counter_id bigint;
...
$_$;
  ...
  def down
    execute %q{
      drop table billing.package_counters;
      alter table class4.destinations drop column allow_package_billing;

      alter type switch21.callprofile_ty drop attribute package_counter_id;
      delete from switch21.switch_interface_out where id = 1047;
