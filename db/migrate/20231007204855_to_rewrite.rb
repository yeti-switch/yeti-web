class ToRewrite < ActiveRecord::Migration[7.0]

  def up
    execute %q{

    alter table class4.gateways
      add to_rewrite_rule varchar,
      add to_rewrite_result varchar;
...
$_$;
  ...
  def down
    ...
    alter table class4.gateways
      drop column to_rewrite_rule,
      drop column to_rewrite_result;
