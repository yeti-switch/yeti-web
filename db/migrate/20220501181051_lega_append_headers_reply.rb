class LegaAppendHeadersReply < ActiveRecord::Migration[6.1]
  def up
    execute %q{

alter table class4.gateways add orig_append_headers_reply varchar[];
...
alter table class4.gateways drop column orig_append_headers_reply;
