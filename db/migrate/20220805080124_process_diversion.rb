  ...
  def up
    execute %q{
      ...
      alter table class4.gateways
        add diversion_send_mode_id smallint not null references class4.gateway_diversion_send_modes(id) default 1,
        add diversion_domain varchar,
        add try_avoid_transcoding boolean not null default false;

      alter table data_import.import_gateways
        add diversion_send_mode_id smallint,
        add diversion_send_mode_name varchar,
        add try_avoid_transcoding boolean;

      alter table class4.gateways
        drop column diversion_policy_id,
        drop column anonymize_sdp,
        drop column transparent_seqno,
        drop column transparent_ssrc;

      alter table data_import.import_gateways
        drop column diversion_policy_id,
        drop column diversion_policy_name,
        drop column anonymize_sdp,
        drop column transparent_seqno,
        drop column transparent_ssrc;
...
DROP FUNCTION switch20.process_dp(i_profile switch20.callprofile_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_pop_id integer, i_send_billing_information boolean, i_max_call_length integer);
DROP FUNCTION switch20.process_dp_release(i_profile switch20.callprofile_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_pop_id integer, i_send_billing_information boolean, i_max_call_length integer);
DROP FUNCTION switch20.process_dp_debug(i_profile switch20.callprofile_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_pop_id integer, i_send_billing_information boolean, i_max_call_length integer);
CREATE FUNCTION switch20.process_dp(i_profile switch20.callprofile_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_pop_id integer, i_send_billing_information boolean, i_max_call_length integer, i_diversion varchar[]) RETURNS SETOF switch20.callprofile_ty
...
DROP FUNCTION switch20.process_gw(i_profile switch20.callprofile_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_vendor_gw class4.gateways, i_send_billing_information boolean, i_max_call_length integer);
DROP FUNCTION switch20.process_gw_release(i_profile switch20.callprofile_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_vendor_gw class4.gateways, i_send_billing_information boolean, i_max_call_length integer);
DROP FUNCTION switch20.process_gw_debug(i_profile switch20.callprofile_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_vendor_gw class4.gateways, i_send_billing_information boolean, i_max_call_length integer);

CREATE FUNCTION switch20.process_gw(i_profile switch20.callprofile_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_vendor_gw class4.gateways, i_send_billing_information boolean, i_max_call_length integer, i_diversion varchar[]) RETURNS switch20.callprofile_ty
...
DROP FUNCTION switch20.process_dp(i_profile switch20.callprofile_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_pop_id integer, i_send_billing_information boolean, i_max_call_length integer, i_diversion varchar[]);
DROP FUNCTION switch20.process_dp_release(i_profile switch20.callprofile_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_pop_id integer, i_send_billing_information boolean, i_max_call_length integer, i_diversion varchar[]);
DROP FUNCTION switch20.process_dp_debug(i_profile switch20.callprofile_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_pop_id integer, i_send_billing_information boolean, i_max_call_length integer, i_diversion varchar[]);
...
drop FUNCTION switch20.process_gw(i_profile switch20.callprofile_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_vendor_gw class4.gateways, i_send_billing_information boolean, i_max_call_length integer, i_diversion varchar[]);
drop FUNCTION switch20.process_gw_release(i_profile switch20.callprofile_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_vendor_gw class4.gateways, i_send_billing_information boolean, i_max_call_length integer, i_diversion varchar[]);
drop FUNCTION switch20.process_gw_debug(i_profile switch20.callprofile_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_vendor_gw class4.gateways, i_send_billing_information boolean, i_max_call_length integer, i_diversion varchar[]);
...
$_$;
    ...
    set search_path TO gui, public, switch, billing, class4, runtime_stats, sys, logs, data_import;
      ...
      delete from class4.diversion_policy where id=2;
      update class4.diversion_policy set name='Clear header' where id=1;

      alter table class4.gateways
        drop column diversion_send_mode_id,
        drop column diversion_domain,
        drop column try_avoid_transcoding;

      alter table data_import.import_gateways
        drop column diversion_send_mode_id,
        drop column diversion_send_mode_name,
        drop column try_avoid_transcoding;

      alter table class4.gateways
        add diversion_policy_id integer not null default 1 references class4.diversion_policy(id),
        add anonymize_sdp boolean not null default true,
        add transparent_seqno boolean not null default false,
        add transparent_ssrc boolean not null default false;

       alter table data_import.import_gateways
        add diversion_policy_id integer,
        add diversion_policy_name varchar,
        add anonymize_sdp boolean,
        add transparent_seqno boolean,
        add transparent_ssrc boolean;

      drop table class4.gateway_diversion_send_modes;
    }
  end
