class AddStirShakenValidation < ActiveRecord::Migration[7.0]
  def up
    execute %q{

INSERT INTO class4.disconnect_code (id, namespace_id, stop_hunting, pass_reason_to_originator, code, reason, rewrited_code, rewrited_reason, success, successnozerolen, store_cdr, silently_drop) VALUES (8018, 0, true, true, 403, 'Identity required', NULL, NULL, false, false, true, false);
INSERT INTO class4.disconnect_code (id, namespace_id, stop_hunting, pass_reason_to_originator, code, reason, rewrited_code, rewrited_reason, success, successnozerolen, store_cdr, silently_drop) VALUES (8019, 0, true, true, 403, 'Identity invalid', NULL, NULL, false, false, true, false);


alter table class4.customers_auth
  add ss_mode_id smallint not null default 0,
  add ss_no_identity_action_id smallint not null default 0,
  add ss_invalid_identity_action_id smallint not null default 0;
...
update class4.customers_auth set ss_mode_id=2 WHERE rewrite_ss_status_id is not null;
...
$_$;
  ...
  def down
    ...
    DELETE FROM class4.disconnect_code WHERE id IN (8018,8019);

   alter table class4.customers_auth
    drop column ss_mode_id,
    drop column ss_no_identity_action_id,
    drop column ss_invalid_identity_action_id;
