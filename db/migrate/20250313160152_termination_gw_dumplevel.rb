class TerminationGwDumplevel < ActiveRecord::Migration[7.2]
  def up
    execute %q{
      alter table class4.gateways add dump_level_id smallint not null default 0;
...
$_$;
      ...
      alter table class4.gateways drop column dump_level_id;
    }
  end
