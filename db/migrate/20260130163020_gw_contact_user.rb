  ...
  def up
    execute %q{
      ...
      alter type switch22.callprofile_ty
        add attribute aleg_contact_user varchar,
        add attribute bleg_contact_user varchar;
...
$_$;
    ...
    set search_path TO gui, public, switch, billing, class4, runtime_stats, sys, logs, data_import;
      ...
      alter type switch22.callprofile_ty
        drop attribute aleg_contact_user,
        drop attribute bleg_contact_user;

      delete from switch22.switch_interface_out where name in ('aleg_contact_user','bleg_contact_user');
    }
  end
