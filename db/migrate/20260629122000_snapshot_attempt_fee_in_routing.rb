...
class SnapshotAttemptFeeInRouting < ActiveRecord::Migration[7.2]
  # Snapshot destination_attempt_fee/dialpeer_attempt_fee onto the call profile in the
  # routing SPs, mirroring destination_fee/dialpeer_fee. Only the BASE switch22.process_gw
  # and switch22.route are defined here; switch22.preprocess_all() regenerates the
  # _debug/_release variants.
  def up
    execute %q{
