class Switch21RemoveDeprecatedResources < ActiveRecord::Migration[7.0]
  def up
    execute %q{

delete from switch21.switch_interface_out where name in (
  'resources',
  'cache_time',
  'aleg_symmetric_rtp_ignore_rtcp',
  'bleg_symmetric_rtp_ignore_rtcp',
  'contact_displayname',
  'contact_host',
  'contact_port',
  'contact_user'
...
ALTER TYPE switch21.callprofile_ty drop attribute resources;
ALTER TYPE switch21.callprofile_ty drop attribute cache_time;

ALTER TYPE switch21.callprofile_ty drop attribute aleg_symmetric_rtp_ignore_rtcp;
ALTER TYPE switch21.callprofile_ty drop attribute bleg_symmetric_rtp_ignore_rtcp;

ALTER TYPE switch21.callprofile_ty drop attribute contact_displayname;
ALTER TYPE switch21.callprofile_ty drop attribute contact_host;
...
ALTER TYPE switch21.callprofile_ty add attribute resources varchar;
ALTER TYPE switch21.callprofile_ty add attribute cache_time integer;

ALTER TYPE switch21.callprofile_ty add attribute aleg_symmetric_rtp_ignore_rtcp boolean;
ALTER TYPE switch21.callprofile_ty add attribute bleg_symmetric_rtp_ignore_rtcp boolean;

ALTER TYPE switch21.callprofile_ty add attribute contact_displayname varchar;
