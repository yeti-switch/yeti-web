class StirShakenCrtInheritance < ActiveRecord::Migration[7.2]
  def up
    execute %q{
      alter table class4.customers_auth add stir_shaken_crt_id smallint;
      alter table class4.customers_auth_normalized add stir_shaken_crt_id smallint;
      alter table data_import.import_customers_auth
        add stir_shaken_crt_name varchar,
        add stir_shaken_crt_id smallint;
...
$_$;
  ...
  def down
    execute %q{
      alter table class4.customers_auth drop column stir_shaken_crt_id;
      alter table class4.customers_auth_normalized drop column stir_shaken_crt_id;
      alter table data_import.import_customers_auth
        drop column stir_shaken_crt_name,
