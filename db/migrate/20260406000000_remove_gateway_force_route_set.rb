...
class RemoveGatewayForceRouteSet < ActiveRecord::Migration[7.0]
  def up
    execute %q{
      ALTER TABLE class4.gateways
        DROP COLUMN term_force_route_set,
        DROP COLUMN orig_force_route_set;
...
$_$;
      ...
      ALTER TYPE switch22.callprofile_ty
        DROP ATTRIBUTE force_outbound_proxy,
        DROP ATTRIBUTE aleg_force_outbound_proxy;
    }
  end
  ...
  def down
    execute %q{
      ALTER TABLE class4.gateways
        ADD COLUMN term_force_route_set boolean NOT NULL DEFAULT false,
        ADD COLUMN orig_force_route_set boolean NOT NULL DEFAULT false;

      ALTER TABLE data_import.import_gateways
        ADD COLUMN term_force_route_set boolean,
        ADD COLUMN orig_force_route_set boolean;

      ALTER TYPE switch22.callprofile_ty
        ADD ATTRIBUTE force_outbound_proxy boolean,
        ADD ATTRIBUTE aleg_force_outbound_proxy boolean;
