class PerRoutingPlanNumberlists < ActiveRecord::Migration[7.0]
  def up
    execute %q{
      alter table class4.routing_plans
        add src_numberlist_id smallint references class4.numberlists(id),
        add dst_numberlist_id smallint references class4.numberlists(id);
...
**/
      ...
      alter table class4.routing_plans
        drop column src_numberlist_id,
        drop column dst_numberlist_id;

      drop index class4.customers_auth_src_numberlist_id_idx;
      drop index class4.customers_auth_dst_numberlist_id_idx;
      drop index class4.gateways_src_numberlist_id_idx;
      drop index class4.gateways_dst_numberlist_id_idx;
      drop index class4.customers_auth_normalized_customers_auth_id;
