...
CREATE OR REPLACE FUNCTION switch20.build_uri(
  i_canonical boolean,
  i_schema varchar,
  i_display_name varchar,
  i_username varchar,
  i_username_params varchar[],
  i_domain varchar,
  i_port integer,
  i_uri_params varchar[]
)
returns varchar LANGUAGE plpgsql STABLE SECURITY DEFINER COST 10
AS $_$
DECLARE
...
DROP FUNCTION switch20.build_uri(
  i_canonical boolean,
  i_schema varchar,
  i_display_name varchar,
  i_username varchar,
