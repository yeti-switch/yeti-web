class DestinationDo < ActiveRecord::Migration[7.2]
  def up
    execute %q{
      alter table class4.destinations add cdo smallint;

      alter type switch22.callprofile_ty add attribute destination_cdo smallint;
...
**/
    ...
    set search_path TO gui, public, switch, billing, class4, runtime_stats, sys, logs, data_import;
      ...
      alter type switch22.callprofile_ty drop attribute destination_cdo;
      alter table class4.destinations drop column cdo;

      delete from switch22.switch_interface_out where id=1050;
