class StirShakenRewriteRules < ActiveRecord::Migration[7.0]

  def up
    execute %q{

      alter table class4.customers_auth
        add ss_src_rewrite_rule varchar,
        add ss_src_rewrite_result varchar,
        add ss_dst_rewrite_rule varchar,
        add ss_dst_rewrite_result varchar;
...
**/
  ...
  def down
    execute %q{
      ...
      alter table class4.customers_auth
        drop column ss_src_rewrite_rule,
        drop column ss_src_rewrite_result,
        drop column ss_dst_rewrite_rule,
        drop column ss_dst_rewrite_result;
