class RoutingAddCustomerAuthExternalType < ActiveRecord::Migration[7.0]
  def up
    execute %q{
      ALTER TYPE switch20.callprofile_ty ADD ATTRIBUTE customer_auth_external_type varchar;
...
**/
      ...
      ALTER TYPE switch20.callprofile_ty DROP ATTRIBUTE customer_auth_external_type;
      delete from switch20.switch_interface_out where id = 1042;
    }
  end
end
