...
class AddCurrencyToDialpeers < ActiveRecord::Migration[7.2]
  def up
    execute %q{
      ALTER TABLE class4.dialpeers ADD COLUMN currency_id smallint REFERENCES billing.currencies(id);
      UPDATE class4.dialpeers SET currency_id = 0;
      ALTER TABLE class4.dialpeers ALTER COLUMN currency_id SET NOT NULL;
      ALTER TABLE class4.dialpeers ADD COLUMN currency_rate double precision NOT NULL DEFAULT 1;
      ALTER TABLE class4.dialpeers ADD COLUMN next_rate_system_currency numeric;
      UPDATE class4.dialpeers SET next_rate_system_currency = next_rate;
      ALTER TABLE class4.dialpeers ALTER COLUMN next_rate_system_currency SET NOT NULL;
...
$_$;
    ...
    execute %q{
      DROP INDEX IF EXISTS class4.dialpeers_currency_id_idx;
      ALTER TABLE data_import.import_dialpeers DROP COLUMN IF EXISTS currency_id;
