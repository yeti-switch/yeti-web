  ...
  def up
    execute %q{
      ...
      alter type switch22.callprofile_ty
        add attribute push_token varchar;

      INSERT INTO switch22.switch_interface_out (id, name, type, custom, rank, for_radius) VALUES (1062, 'push_token', 'varchar', false, 1999, false);
...
set search_path TO gui, public, switch, billing, class4, runtime_stats, sys, logs, data_import;
      ...
      delete from switch22.switch_interface_out where name = 'push_token';

      alter type switch22.callprofile_ty
        drop attribute push_token;
