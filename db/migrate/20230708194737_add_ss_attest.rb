class AddSsAttest < ActiveRecord::Migration[7.0]
  def up
    execute %q{
      ...
      alter table class4.customers_auth add rewrite_ss_status_id smallint;
      alter table class4.customers_auth_normalized add rewrite_ss_status_id smallint;
