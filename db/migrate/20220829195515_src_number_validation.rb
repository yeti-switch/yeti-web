class SrcNumberValidation < ActiveRecord::Migration[6.1]
  def up
    execute %q{

    alter table class4.routing_plans
      add validate_src_number_format boolean not null default false,
      add validate_src_number_network boolean not null default false;
...
**/
    ...
    alter table class4.routing_plans
      drop column validate_src_number_format,
      drop column validate_src_number_network;

    delete from class4.disconnect_code where id in (8010,8011);
