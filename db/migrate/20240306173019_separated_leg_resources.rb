class SeparatedLegResources < ActiveRecord::Migration[7.0]

  def up
    execute %q{

    alter type switch20.callprofile_ty
      add attribute lega_res varchar,
      add attribute legb_res varchar;
...
$_$;
    ...
    alter type switch20.callprofile_ty
      drop attribute lega_res,
      drop attribute legb_res;
