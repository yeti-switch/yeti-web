class FixCallLengthLimitation < ActiveRecord::Migration[5.2]
  def up
    execute %q{


  alter table class4.gateways alter column proxy_media set default true;
  update class4.gateways set proxy_media = true;


CREATE or replace FUNCTION switch18.process_gw(i_profile switch18.callprofile62_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_vendor_gw class4.gateways, i_send_billing_information boolean, i_max_call_length integer) RETURNS switch18.callprofile62_ty
...
alter table class4.gateways alter column proxy_media set default false;
