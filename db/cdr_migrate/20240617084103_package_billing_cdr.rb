class PackageBillingCdr < ActiveRecord::Migration[7.0]
  def up
    execute %q{
    alter table cdr.cdr add package_counter_id bigint;
    alter type switch.dynamic_cdr_data_ty add attribute package_counter_id bigint;
...
$$;
  ...
  alter type switch.dynamic_cdr_data_ty drop attribute package_counter_id;
  alter table cdr.cdr drop package_counter_id;
