class AddInternalDisconnectCodeId < ActiveRecord::Migration[7.0]
  def up
    execute %q{
      alter table cdr.cdr add internal_disconnect_code_id smallint;
...
i_internal_disconnect_code_id smallint,
...
i_lega_identity json);
      ...
      alter table cdr.cdr drop column internal_disconnect_code_id;
    }
  end
end
