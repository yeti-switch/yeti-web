class SwitchDumpLevelIdToSmallint < ActiveRecord::Migration[6.1]
  def up
    execute %q{
      alter table cdr.cdr drop column dump_level_id;
      alter table cdr.cdr add column dump_level_id smallint;
...
$$;
  ...
  def down
    execute %q{
      alter table cdr.cdr drop column dump_level_id;
      alter table cdr.cdr add column dump_level_id integer;
