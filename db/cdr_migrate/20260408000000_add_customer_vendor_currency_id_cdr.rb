...
class AddCustomerVendorCurrencyIdCdr < ActiveRecord::Migration[7.2]
  def up
    execute %q{
      ALTER TABLE cdr.cdr
        ADD COLUMN customer_currency_id smallint,
        ADD COLUMN vendor_currency_id smallint,
        ADD COLUMN customer_currency_rate double precision,
        ADD COLUMN vendor_currency_rate double precision;
...
$$;
    ...
    execute %q{
      ...
      ALTER TABLE cdr.cdr
        DROP COLUMN customer_currency_id,
        DROP COLUMN vendor_currency_id,
        DROP COLUMN customer_currency_rate,
        DROP COLUMN vendor_currency_rate;
    }
  end
end
