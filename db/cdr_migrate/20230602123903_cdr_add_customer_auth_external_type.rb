class CdrAddCustomerAuthExternalType < ActiveRecord::Migration[7.0]
  def up
    execute %q{
        ALTER TABLE cdr.cdr ADD customer_auth_external_type varchar;
        ALTER TYPE switch.dynamic_cdr_data_ty ADD ATTRIBUTE customer_auth_external_type varchar;
...
$$;
  ...
  def down
    execute %q{
        ALTER TABLE cdr.cdr DROP customer_auth_external_type;
        ALTER TYPE switch.dynamic_cdr_data_ty DROP ATTRIBUTE customer_auth_external_type;
