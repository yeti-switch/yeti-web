class WriteReasonToCdr < ActiveRecord::Migration[7.0]
  def up
    execute %q{
      alter table cdr.cdr
        add lega_reason varchar,
        add legb_reason varchar;
...
$$;
      ...
      alter table cdr.cdr
        drop column lega_reason,
        drop column legb_reason;

      alter type switch.lega_headers_ty drop attribute reason;
      drop type switch.legb_headers_ty;
