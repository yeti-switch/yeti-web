class AddIdentityValidationStatus < ActiveRecord::Migration[6.1]

  def up
    execute %q{
      alter table cdr.cdr
        add lega_identity_attestation_id smallint,
        add lega_identity_verstat_id smallint;
...
$BODY$
  ...
  COST 10;
      ...
      alter table cdr.cdr
        drop column lega_identity_attestation_id,
        drop column lega_identity_verstat_id;
