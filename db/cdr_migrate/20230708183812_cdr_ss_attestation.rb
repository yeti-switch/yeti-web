class CdrSsAttestation < ActiveRecord::Migration[7.0]
  def up
    execute %q{
        alter table cdr.cdr
            rename column lega_identity_attestation_id to lega_ss_status_id;
        alter table cdr.cdr
            rename column lega_identity_verstat_id to legb_ss_status_id;

        ALTER TYPE switch.dynamic_cdr_data_ty RENAME ATTRIBUTE lega_identity_attestation_id to lega_ss_status_id;
        ALTER TYPE switch.dynamic_cdr_data_ty RENAME ATTRIBUTE lega_identity_verstat_id to legb_ss_status_id;
...
DROP TYPE billing.cdr_v2;
  ...
  def down
    execute %q{
        alter table cdr.cdr
            rename column lega_ss_status_id to lega_identity_attestation_id;
        alter table cdr.cdr
            rename column legb_ss_status_id to lega_identity_verstat_id;

        ALTER TYPE switch.dynamic_cdr_data_ty RENAME ATTRIBUTE lega_ss_status_id to lega_identity_attestation_id;
        ALTER TYPE switch.dynamic_cdr_data_ty RENAME ATTRIBUTE legb_ss_status_id to lega_identity_verstat_id;
