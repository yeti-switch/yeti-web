...
INSERT INTO disconnect_code (id, namespace_id, stop_hunting, pass_reason_to_originator, code, reason, rewrited_code, rewrited_reason, success, successnozerolen, store_cdr, silently_drop) VALUES (144, 1, true, false, 500, 'Media stream exception', NULL, 'Media stream exception', false, false, true, false);
...
INSERT INTO disconnect_code (id, namespace_id, stop_hunting, pass_reason_to_originator, code, reason, rewrited_code, rewrited_reason, success, successnozerolen, store_cdr, silently_drop) VALUES (146, 1, true, false, 487, 'Canceled before routing completed', NULL, NULL, false, false, true, false);
