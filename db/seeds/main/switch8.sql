...
-- Started on 2017-08-20 19:27:48 EEST
...
-- Dependencies: 493
-- Name: events_id_seq; Type: SEQUENCE SET; Schema: switch8; Owner: yeti
--
...
--
-- TOC entry 3869 (class 0 OID 19965)
-- Dependencies: 494
-- Data for Name: resource_action; Type: TABLE DATA; Schema: switch8; Owner: yeti
--
...
--
-- TOC entry 3867 (class 0 OID 18943)
-- Dependencies: 282
-- Data for Name: resource_type; Type: TABLE DATA; Schema: switch8; Owner: yeti
--
...
-- Dependencies: 495
-- Name: resource_type_id_seq; Type: SEQUENCE SET; Schema: switch8; Owner: yeti
--
...
-- Dependencies: 496
-- Name: switch_in_interface_id_seq; Type: SEQUENCE SET; Schema: switch8; Owner: yeti
--
...
-- Dependencies: 498
-- Name: switch_interface_id_seq; Type: SEQUENCE SET; Schema: switch8; Owner: yeti
--
...
--
-- TOC entry 3874 (class 0 OID 19983)
-- Dependencies: 499
-- Data for Name: switch_interface_in; Type: TABLE DATA; Schema: switch8; Owner: yeti
--
...
--
-- TOC entry 3872 (class 0 OID 19975)
-- Dependencies: 497
-- Data for Name: switch_interface_out; Type: TABLE DATA; Schema: switch8; Owner: yeti
--
...
INSERT INTO switch_interface_out VALUES (876, 'suppress_early_media', 'boolean', false, 1018);
INSERT INTO switch_interface_out VALUES (877, 'aleg_relay_update', 'boolean', false, 1019);
INSERT INTO switch_interface_out VALUES (878, 'bleg_relay_update', 'boolean', false, 1020);
INSERT INTO switch_interface_out VALUES (951, 'aleg_relay_reinvite', 'boolean', false, 990);
INSERT INTO switch_interface_out VALUES (879, 'bleg_relay_reinvite', 'boolean', false, 991);
INSERT INTO switch_interface_out VALUES (880, 'aleg_relay_hold', 'boolean', false, 992);
INSERT INTO switch_interface_out VALUES (881, 'bleg_relay_hold', 'boolean', false, 993);
INSERT INTO switch_interface_out VALUES (882, 'aleg_relay_prack', 'boolean', false, 994);
INSERT INTO switch_interface_out VALUES (883, 'bleg_relay_prack', 'boolean', false, 995);
INSERT INTO switch_interface_out VALUES (884, 'destination_prefix', 'varchar', true, 1711);
INSERT INTO switch_interface_out VALUES (885, 'dialpeer_prefix', 'varchar', true, 1721);
INSERT INTO switch_interface_out VALUES (886, 'lrn', 'varchar', true, 1936);
INSERT INTO switch_interface_out VALUES (887, 'lnp_database_id', 'smallint', true, 1937);


--
-- TOC entry 3875 (class 0 OID 19991)
-- Dependencies: 500
-- Data for Name: trusted_headers; Type: TABLE DATA; Schema: switch8; Owner: yeti
--
...
-- Dependencies: 501
-- Name: trusted_headers_id_seq; Type: SEQUENCE SET; Schema: switch8; Owner: yeti
--

SELECT pg_catalog.setval('trusted_headers_id_seq', 2, true);


-- Completed on 2017-08-20 19:27:48 EEST
