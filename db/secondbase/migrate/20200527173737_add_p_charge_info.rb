class AddPChargeInfo < ActiveRecord::Migration[5.2]
  def up
    execute %q{
      alter table cdr.cdr add p_charge_info_in varchar;
...
$BODY$
  ...
  def down
    ...
    i_lega_headers json
      ...
      drop type switch.lega_headers_ty;

      alter table cdr.cdr drop column p_charge_info_in;
    }
  end
end
