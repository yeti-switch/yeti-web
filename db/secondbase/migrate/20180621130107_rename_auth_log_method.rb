class RenameAuthLogMethod < ActiveRecord::Migration[5.1]
  def up
    execute %q{

      alter table auth_log.auth_log rename column method to request_method;
...
$BODY$
  ...
  def down
    execute %q{
    alter table auth_log.auth_log rename column request_method to method;
