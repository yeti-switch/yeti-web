  ...
  def up
    execute %q{
      ...
      alter table billing.invoices
        add billing_duration bigint;

      update billing.invoices set billing_duration=calls_duration;
      alter table billing.invoices
        alter column billing_duration set not null;
