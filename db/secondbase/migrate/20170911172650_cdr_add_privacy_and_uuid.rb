  ...
  def up
    execute %q{
      ...
      alter table cdr.cdr
        ...
        add pai_in varchar,
        add ppi_in varchar,
        add privacy_in varchar,
        add rpid_in varchar,
        add rpid_privacy_in varchar,
        add pai_out varchar,
        add ppi_out varchar,
        add privacy_out varchar,
        add rpid_out varchar,
        add rpid_privacy_out varchar;
...
CREATE OR REPLACE FUNCTION switch.writecdr(
    ...
    i_pai_in varchar,
    i_ppi_in varchar,
    i_privacy_in varchar,
    i_rpid_in varchar,
    i_rpid_privacy_in varchar,
    i_pai_out varchar,
    i_ppi_out varchar,
    i_privacy_out varchar,
    i_rpid_out varchar,
    i_rpid_privacy_out varchar
    )
  RETURNS integer AS
$BODY$
DECLARE
...
$BODY$
  ...
  def down
    execute %q{
      DROP FUNCTION switch.writecdr(boolean, integer, integer, integer, boolean, smallint, character varying, integer, character varying, integer, smallint, character varying, integer, character varying, integer, json, boolean, integer, character varying, integer, integer, character varying, integer, character varying, character varying, character varying, character varying, character varying, integer, boolean, json, character varying, character varying, json, smallint, bigint, json, json, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, integer, integer, integer, integer, integer, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, smallint, inet, integer, integer, integer, character varying, character varying, integer, character varying, smallint, character varying, character varying, character varying, integer, integer, smallint, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying);

      alter table cdr.cdr
        drop column uuid,
        drop column pai_in,
        drop column ppi_in,
        drop column privacy_in,
        drop column rpid_in,
        drop column rpid_privacy_in,
        drop column pai_out,
        drop column ppi_out,
        drop column privacy_out,
        drop column rpid_out,
        drop column rpid_privacy_out;
