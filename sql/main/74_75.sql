begin;
insert into sys.version(number,comment) values(75,'route fix');

set search_path TO switch9;

alter table class4.customers_auth add radius_accounting_profile_id smallint references class4.radius_accounting_profiles(id);
ALTER TABLE class4.gateways ADD radius_accounting_profile_id smallint references class4.radius_accounting_profiles(id);
...
-- Started on 2016-03-12 11:57:07 EET
...
--
-- TOC entry 35 (class 2615 OID 32995)
...
--
-- TOC entry 1931 (class 1247 OID 33408)
...
--
-- TOC entry 1672 (class 1247 OID 33607)
...
--
-- TOC entry 1784 (class 1247 OID 33654)
...
--
-- TOC entry 2149 (class 1247 OID 33720)
...
--
-- TOC entry 1745 (class 1247 OID 33295)
...
--
-- TOC entry 1216 (class 1255 OID 33206)
...
--
-- TOC entry 1196 (class 1255 OID 33015)
...
--
-- TOC entry 1222 (class 1255 OID 33415)
...
--
-- TOC entry 1198 (class 1255 OID 33017)
...
--
-- TOC entry 1199 (class 1255 OID 33018)
...
--
-- TOC entry 1220 (class 1255 OID 33019)
...
--
-- TOC entry 1212 (class 1255 OID 33296)
...
--
-- TOC entry 1200 (class 1255 OID 33020)
...
--
-- TOC entry 1201 (class 1255 OID 33021)
...
--
-- TOC entry 1208 (class 1255 OID 33022)
...
--
-- TOC entry 1202 (class 1255 OID 33023)
...
--
-- TOC entry 1203 (class 1255 OID 33024)
...
--
-- TOC entry 1204 (class 1255 OID 33025)
...
--
-- TOC entry 1205 (class 1255 OID 33026)
...
--
-- TOC entry 1206 (class 1255 OID 33027)
...
--
-- TOC entry 1207 (class 1255 OID 33028)
...
--
-- TOC entry 1223 (class 1255 OID 33604)
...
--
-- TOC entry 1215 (class 1255 OID 33201)
...
--
-- TOC entry 1230 (class 1255 OID 33715)
...
BEGIN
    ...
    from class4.radius_accounting_profiles p
        left JOIN class4.radius_accounting_profile_start_attributes start ON p.id=start.profile_id
        left JOIN class4.radius_accounting_profile_interim_attributes interim ON p.id=interim.profile_id
        left JOIN class4.radius_accounting_profile_stop_attributes stop ON p.id=stop.profile_id
    GROUP by
        p.id, 
        p.name,
        p.server,
...
--
-- TOC entry 1221 (class 1255 OID 33405)
...
--
-- TOC entry 1032 (class 1255 OID 33031)
...
--
-- TOC entry 506 (class 1259 OID 33032)
...
--
-- TOC entry 1033 (class 1255 OID 33039)
...
--
-- TOC entry 1034 (class 1255 OID 33040)
...
--
-- TOC entry 1035 (class 1255 OID 33041)
...
--
-- TOC entry 1231 (class 1255 OID 33721)
-- Name: new_profile(); Type: FUNCTION; Schema: switch9; Owner: -
--

CREATE FUNCTION new_profile() RETURNS callprofile48_ty
    LANGUAGE plpgsql COST 10
    AS $_$
DECLARE
    v_ret switch9.callprofile48_ty;
BEGIN
...
--
-- TOC entry 1036 (class 1255 OID 33043)
...
--
-- TOC entry 1037 (class 1255 OID 33044)
...
--
-- TOC entry 1232 (class 1255 OID 33722)
-- Name: process_dp(callprofile48_ty, class4.destinations, class4.dialpeers, billing.accounts, class4.gateways, billing.accounts, integer, boolean, integer); Type: FUNCTION; Schema: switch9; Owner: -
--

CREATE FUNCTION process_dp(i_profile callprofile48_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_pop_id integer, i_send_billing_information boolean, i_max_call_length integer) RETURNS SETOF callprofile48_ty
...
--
-- TOC entry 1225 (class 1255 OID 33737)
-- Name: process_dp_debug(callprofile48_ty, class4.destinations, class4.dialpeers, billing.accounts, class4.gateways, billing.accounts, integer, boolean, integer); Type: FUNCTION; Schema: switch9; Owner: -
--

CREATE FUNCTION process_dp_debug(i_profile callprofile48_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_pop_id integer, i_send_billing_information boolean, i_max_call_length integer) RETURNS SETOF callprofile48_ty
    LANGUAGE plpgsql STABLE SECURITY DEFINER COST 10000
    AS $$
DECLARE
/*dbg{*/
...
--
-- TOC entry 1226 (class 1255 OID 33738)
-- Name: process_dp_release(callprofile48_ty, class4.destinations, class4.dialpeers, billing.accounts, class4.gateways, billing.accounts, integer, boolean, integer); Type: FUNCTION; Schema: switch9; Owner: -
--

CREATE FUNCTION process_dp_release(i_profile callprofile48_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_pop_id integer, i_send_billing_information boolean, i_max_call_length integer) RETURNS SETOF callprofile48_ty
    LANGUAGE plpgsql STABLE SECURITY DEFINER COST 10000
    AS $$
DECLARE
...
--
-- TOC entry 943 (class 1255 OID 33723)
-- Name: process_gw(callprofile48_ty, class4.destinations, class4.dialpeers, billing.accounts, class4.gateways, billing.accounts, class4.gateways, boolean, integer); Type: FUNCTION; Schema: switch9; Owner: -
--

CREATE FUNCTION process_gw(i_profile callprofile48_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_vendor_gw class4.gateways, i_send_billing_information boolean, i_max_call_length integer) RETURNS callprofile48_ty
...
--
-- TOC entry 1228 (class 1255 OID 33739)
-- Name: process_gw_debug(callprofile48_ty, class4.destinations, class4.dialpeers, billing.accounts, class4.gateways, billing.accounts, class4.gateways, boolean, integer); Type: FUNCTION; Schema: switch9; Owner: -
--

CREATE FUNCTION process_gw_debug(i_profile callprofile48_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_vendor_gw class4.gateways, i_send_billing_information boolean, i_max_call_length integer) RETURNS callprofile48_ty
    LANGUAGE plpgsql STABLE SECURITY DEFINER COST 100000
    AS $_$
DECLARE
i integer;
...
--
-- TOC entry 1229 (class 1255 OID 33741)
-- Name: process_gw_release(callprofile48_ty, class4.destinations, class4.dialpeers, billing.accounts, class4.gateways, billing.accounts, class4.gateways, boolean, integer); Type: FUNCTION; Schema: switch9; Owner: -
--

CREATE FUNCTION process_gw_release(i_profile callprofile48_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_vendor_gw class4.gateways, i_send_billing_information boolean, i_max_call_length integer) RETURNS callprofile48_ty
    LANGUAGE plpgsql STABLE SECURITY DEFINER COST 100000
    AS $_$
DECLARE
i integer;
...
--
-- TOC entry 1209 (class 1255 OID 33054)
...
--
-- TOC entry 1233 (class 1255 OID 33725)
...
CREATE FUNCTION route(i_node_id integer, i_pop_id integer, i_remote_ip inet, i_remote_port integer, i_local_ip inet, i_local_port integer, i_from_dsp character varying, i_from_name character varying, i_from_domain character varying, i_from_port integer, i_to_name character varying, i_to_domain character varying, i_to_port integer, i_contact_name character varying, i_contact_domain character varying, i_contact_port integer, i_uri_name character varying, i_uri_domain character varying, i_x_yeti_auth character varying, i_diversion character varying, i_x_orig_ip inet, i_x_orig_port integer) RETURNS SETOF callprofile48_ty
    LANGUAGE plpgsql SECURITY DEFINER ROWS 10
    AS $$
DECLARE
  v_ret switch9.callprofile48_ty;
...
BEGIN
  ...
  */
  ...
  if v_ret.radius_auth_profile_id is not null then
    ...
    if v_customer_auth.src_number_radius_rewrite_rule is not null and v_customer_auth.src_number_radius_rewrite_rule!='' then
      v_ret.src_number_radius=regexp_replace(
    ...
    if v_customer_auth.dst_number_radius_rewrite_rule is not null and v_customer_auth.dst_number_radius_rewrite_rule!='' then
      v_ret.dst_number_radius=regexp_replace(
...
--
-- TOC entry 1227 (class 1255 OID 33733)
...
CREATE FUNCTION route_debug(i_node_id integer, i_pop_id integer, i_remote_ip inet, i_remote_port integer, i_local_ip inet, i_local_port integer, i_from_dsp character varying, i_from_name character varying, i_from_domain character varying, i_from_port integer, i_to_name character varying, i_to_domain character varying, i_to_port integer, i_contact_name character varying, i_contact_domain character varying, i_contact_port integer, i_uri_name character varying, i_uri_domain character varying, i_x_yeti_auth character varying, i_diversion character varying, i_x_orig_ip inet, i_x_orig_port integer) RETURNS SETOF callprofile48_ty
    LANGUAGE plpgsql SECURITY DEFINER ROWS 10
    AS $$
DECLARE
  v_ret switch9.callprofile48_ty;
...
--
-- TOC entry 1224 (class 1255 OID 33735)
...
CREATE FUNCTION route_release(i_node_id integer, i_pop_id integer, i_remote_ip inet, i_remote_port integer, i_local_ip inet, i_local_port integer, i_from_dsp character varying, i_from_name character varying, i_from_domain character varying, i_from_port integer, i_to_name character varying, i_to_domain character varying, i_to_port integer, i_contact_name character varying, i_contact_domain character varying, i_contact_port integer, i_uri_name character varying, i_uri_domain character varying, i_x_yeti_auth character varying, i_diversion character varying, i_x_orig_ip inet, i_x_orig_port integer) RETURNS SETOF callprofile48_ty
    LANGUAGE plpgsql SECURITY DEFINER ROWS 10
    AS $$
DECLARE
  v_ret switch9.callprofile48_ty;
...
--
-- TOC entry 1210 (class 1255 OID 33061)
...
--
-- TOC entry 1211 (class 1255 OID 33062)
...
--
-- TOC entry 507 (class 1259 OID 33063)
...
--
-- TOC entry 508 (class 1259 OID 33065)
...
--
-- TOC entry 509 (class 1259 OID 33071)
...
--
-- TOC entry 510 (class 1259 OID 33073)
...
--
-- TOC entry 511 (class 1259 OID 33075)
...
--
-- TOC entry 512 (class 1259 OID 33081)
...
--
-- TOC entry 513 (class 1259 OID 33083)
...
--
-- TOC entry 514 (class 1259 OID 33091)
...
--
-- TOC entry 515 (class 1259 OID 33097)
...
--
-- TOC entry 3691 (class 2604 OID 33099)
...
--
-- TOC entry 3693 (class 2604 OID 33100)
-- Name: id; Type: DEFAULT; Schema: switch9; Owner: -
--
...
--
-- TOC entry 3697 (class 2604 OID 33101)
-- Name: id; Type: DEFAULT; Schema: switch9; Owner: -
--
...
--
-- TOC entry 3826 (class 0 OID 33065)
-- Dependencies: 508
...
--
-- TOC entry 3824 (class 0 OID 33032)
-- Dependencies: 506
...
SELECT pg_catalog.setval('switch_interface_id_seq', 901, true);


--
-- TOC entry 3831 (class 0 OID 33083)
-- Dependencies: 513
...
--
-- TOC entry 3829 (class 0 OID 33075)
-- Dependencies: 511
...
INSERT INTO switch_interface_out (id, name, type, custom, rank, for_radius) VALUES (754, 'header_filter_type_id', 'integer', false, 160, false);
...
INSERT INTO switch_interface_out (id, name, type, custom, rank, for_radius) VALUES (755, 'header_filter_list', 'varchar', false, 170, false);
...
--
-- TOC entry 3832 (class 0 OID 33091)
-- Dependencies: 514
...
--
-- TOC entry 3703 (class 2606 OID 33103)
...
--
-- TOC entry 3705 (class 2606 OID 33105)
...
--
-- TOC entry 3699 (class 2606 OID 33107)
...
--
-- TOC entry 3701 (class 2606 OID 33109)
...
--
-- TOC entry 3711 (class 2606 OID 33111)
...
--
-- TOC entry 3713 (class 2606 OID 33113)
...
--
-- TOC entry 3707 (class 2606 OID 33115)
...
--
-- TOC entry 3709 (class 2606 OID 33117)
...
--
-- TOC entry 3715 (class 2606 OID 33119)
...
--
-- TOC entry 3716 (class 2606 OID 33120)
...
-- Completed on 2016-03-12 11:57:39 EET
