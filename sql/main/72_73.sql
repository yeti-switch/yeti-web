begin;
insert into sys.version(number,comment) values(73,'New placeholders for RADIUS');

set search_path TO switch9;

ALTER TABLE class4.customers_auth add enable_audio_recording boolean not null default false;
...
CREATE TABLE class4.radius_accounting_profiles(
  ...
  enable_start_accounting boolean not null default false,
  enable_interim_accounting boolean not null default false,
  interim_accounting_interval smallint not null DEFAULT 30,
  enable_stop_accounting  boolean not null default true
);

CREATE TABLE class4.radius_accounting_profile_start_attributes(
  id smallserial primary key,
  profile_id smallint not null references class4.radius_accounting_profiles(id),
...
-- Started on 2016-02-08 10:52:24 EET
...
--
-- TOC entry 1929 (class 1247 OID 33408)
...
--
-- TOC entry 1670 (class 1247 OID 33607)
...
--
-- TOC entry 1782 (class 1247 OID 33654)
...
--
-- TOC entry 1743 (class 1247 OID 33295)
...
--
-- TOC entry 1030 (class 1255 OID 33031)
...
--
-- TOC entry 1031 (class 1255 OID 33039)
...
--
-- TOC entry 1032 (class 1255 OID 33040)
...
--
-- TOC entry 1033 (class 1255 OID 33041)
...
--
-- TOC entry 1224 (class 1255 OID 33655)
-- Name: new_profile(); Type: FUNCTION; Schema: switch9; Owner: -
--

CREATE FUNCTION new_profile() RETURNS callprofile47_ty
    LANGUAGE plpgsql COST 10
    AS $_$
DECLARE
    v_ret switch9.callprofile47_ty;
BEGIN
...
--
-- TOC entry 1034 (class 1255 OID 33043)
...
--
-- TOC entry 1035 (class 1255 OID 33044)
...
--
-- TOC entry 1225 (class 1255 OID 33656)
-- Name: process_dp(callprofile47_ty, class4.destinations, class4.dialpeers, billing.accounts, class4.gateways, billing.accounts, integer, boolean, integer); Type: FUNCTION; Schema: switch9; Owner: -
--

CREATE FUNCTION process_dp(i_profile callprofile47_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_pop_id integer, i_send_billing_information boolean, i_max_call_length integer) RETURNS SETOF callprofile47_ty
...
--
-- TOC entry 1229 (class 1255 OID 33687)
-- Name: process_dp_debug(callprofile47_ty, class4.destinations, class4.dialpeers, billing.accounts, class4.gateways, billing.accounts, integer, boolean, integer); Type: FUNCTION; Schema: switch9; Owner: -
--

CREATE FUNCTION process_dp_debug(i_profile callprofile47_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_pop_id integer, i_send_billing_information boolean, i_max_call_length integer) RETURNS SETOF callprofile47_ty
    LANGUAGE plpgsql STABLE SECURITY DEFINER COST 10000
    AS $$
DECLARE
/*dbg{*/
...
--
-- TOC entry 1230 (class 1255 OID 33688)
-- Name: process_dp_release(callprofile47_ty, class4.destinations, class4.dialpeers, billing.accounts, class4.gateways, billing.accounts, integer, boolean, integer); Type: FUNCTION; Schema: switch9; Owner: -
--

CREATE FUNCTION process_dp_release(i_profile callprofile47_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_pop_id integer, i_send_billing_information boolean, i_max_call_length integer) RETURNS SETOF callprofile47_ty
    LANGUAGE plpgsql STABLE SECURITY DEFINER COST 10000
    AS $$
DECLARE
...
--
-- TOC entry 1226 (class 1255 OID 33657)
-- Name: process_gw(callprofile47_ty, class4.destinations, class4.dialpeers, billing.accounts, class4.gateways, billing.accounts, class4.gateways, boolean, integer); Type: FUNCTION; Schema: switch9; Owner: -
--

CREATE FUNCTION process_gw(i_profile callprofile47_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_vendor_gw class4.gateways, i_send_billing_information boolean, i_max_call_length integer) RETURNS callprofile47_ty
...
--
-- TOC entry 1231 (class 1255 OID 33689)
-- Name: process_gw_debug(callprofile47_ty, class4.destinations, class4.dialpeers, billing.accounts, class4.gateways, billing.accounts, class4.gateways, boolean, integer); Type: FUNCTION; Schema: switch9; Owner: -
--

CREATE FUNCTION process_gw_debug(i_profile callprofile47_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_vendor_gw class4.gateways, i_send_billing_information boolean, i_max_call_length integer) RETURNS callprofile47_ty
    LANGUAGE plpgsql STABLE SECURITY DEFINER COST 100000
    AS $_$
DECLARE
i integer;
...
--
-- TOC entry 1046 (class 1255 OID 33691)
-- Name: process_gw_release(callprofile47_ty, class4.destinations, class4.dialpeers, billing.accounts, class4.gateways, billing.accounts, class4.gateways, boolean, integer); Type: FUNCTION; Schema: switch9; Owner: -
--

CREATE FUNCTION process_gw_release(i_profile callprofile47_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_vendor_gw class4.gateways, i_send_billing_information boolean, i_max_call_length integer) RETURNS callprofile47_ty
    LANGUAGE plpgsql STABLE SECURITY DEFINER COST 100000
    AS $_$
DECLARE
i integer;
...
--
-- TOC entry 1165 (class 1255 OID 33698)
...
CREATE FUNCTION route(i_node_id integer, i_pop_id integer, i_remote_ip inet, i_remote_port integer, i_local_ip inet, i_local_port integer, i_from_dsp character varying, i_from_name character varying, i_from_domain character varying, i_from_port integer, i_to_name character varying, i_to_domain character varying, i_to_port integer, i_contact_name character varying, i_contact_domain character varying, i_contact_port integer, i_uri_name character varying, i_uri_domain character varying, i_x_yeti_auth character varying, i_diversion character varying, i_x_orig_ip inet, i_x_orig_port integer) RETURNS SETOF callprofile47_ty
    LANGUAGE plpgsql SECURITY DEFINER ROWS 10
    AS $$
DECLARE
  v_ret switch9.callprofile47_ty;
...
--
-- TOC entry 1227 (class 1255 OID 33683)
...
CREATE FUNCTION route_debug(i_node_id integer, i_pop_id integer, i_remote_ip inet, i_remote_port integer, i_local_ip inet, i_local_port integer, i_from_dsp character varying, i_from_name character varying, i_from_domain character varying, i_from_port integer, i_to_name character varying, i_to_domain character varying, i_to_port integer, i_contact_name character varying, i_contact_domain character varying, i_contact_port integer, i_uri_name character varying, i_uri_domain character varying, i_x_yeti_auth character varying, i_diversion character varying, i_x_orig_ip inet, i_x_orig_port integer) RETURNS SETOF callprofile47_ty
    LANGUAGE plpgsql SECURITY DEFINER ROWS 10
    AS $$
DECLARE
  v_ret switch9.callprofile47_ty;
...
--
-- TOC entry 1228 (class 1255 OID 33685)
...
CREATE FUNCTION route_release(i_node_id integer, i_pop_id integer, i_remote_ip inet, i_remote_port integer, i_local_ip inet, i_local_port integer, i_from_dsp character varying, i_from_name character varying, i_from_domain character varying, i_from_port integer, i_to_name character varying, i_to_domain character varying, i_to_port integer, i_contact_name character varying, i_contact_domain character varying, i_contact_port integer, i_uri_name character varying, i_uri_domain character varying, i_x_yeti_auth character varying, i_diversion character varying, i_x_orig_ip inet, i_x_orig_port integer) RETURNS SETOF callprofile47_ty
    LANGUAGE plpgsql SECURITY DEFINER ROWS 10
    AS $$
DECLARE
  v_ret switch9.callprofile47_ty;
...
--
-- TOC entry 3686 (class 2604 OID 33099)
...
--
-- TOC entry 3688 (class 2604 OID 33100)
-- Name: id; Type: DEFAULT; Schema: switch9; Owner: -
--
...
--
-- TOC entry 3692 (class 2604 OID 33101)
-- Name: id; Type: DEFAULT; Schema: switch9; Owner: -
--
...
--
-- TOC entry 3821 (class 0 OID 33065)
-- Dependencies: 499
...
--
-- TOC entry 3819 (class 0 OID 33032)
-- Dependencies: 497
...
SELECT pg_catalog.setval('switch_interface_id_seq', 899, true);


--
-- TOC entry 3826 (class 0 OID 33083)
-- Dependencies: 504
...
--
-- TOC entry 3824 (class 0 OID 33075)
-- Dependencies: 502
...
--
-- TOC entry 3827 (class 0 OID 33091)
-- Dependencies: 505
...
--
-- TOC entry 3698 (class 2606 OID 33103)
...
--
-- TOC entry 3700 (class 2606 OID 33105)
...
--
-- TOC entry 3694 (class 2606 OID 33107)
...
--
-- TOC entry 3696 (class 2606 OID 33109)
...
--
-- TOC entry 3706 (class 2606 OID 33111)
...
--
-- TOC entry 3708 (class 2606 OID 33113)
...
--
-- TOC entry 3702 (class 2606 OID 33115)
...
--
-- TOC entry 3704 (class 2606 OID 33117)
...
--
-- TOC entry 3710 (class 2606 OID 33119)
...
--
-- TOC entry 3711 (class 2606 OID 33120)
...
-- Completed on 2016-02-08 10:52:56 EET
