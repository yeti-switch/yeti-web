begin;
insert into sys.version(number,comment) values(58,'Resources limitation refactoring');

ALTER TABLE billing.accounts ALTER COLUMN origination_capacity DROP NOT NULL ;
ALTER TABLE billing.accounts ALTER COLUMN termination_capacity DROP NOT NULL;

UPDATE billing.accounts set termination_capacity = null where termination_capacity=0;
UPDATE billing.accounts set origination_capacity = null where origination_capacity=0;

ALTER TABLE billing.accounts ALTER COLUMN origination_capacity TYPE smallint;
ALTER TABLE billing.accounts ALTER COLUMN termination_capacity TYPE smallint;


ALTER TABLE class4.gateways ALTER COLUMN capacity DROP NOT NULL ;
UPDATE class4.gateways set capacity = null where capacity=0;
ALTER TABLE class4.gateways ALTER COLUMN capacity TYPE smallint;

ALTER TABLE class4.gateways RENAME COLUMN capacity to termination_capacity;
ALTER TABLE class4.gateways add origination_capacity smallint;


ALTER TABLE class4.customers_auth ALTER COLUMN capacity DROP NOT NULL ;
UPDATE class4.customers_auth set capacity = null where capacity=0;
ALTER TABLE class4.customers_auth ALTER COLUMN capacity TYPE smallint;

ALTER TABLE class4.dialpeers ALTER COLUMN capacity DROP NOT NULL ;
UPDATE class4.dialpeers set capacity = null where capacity=0;
ALTER TABLE class4.dialpeers ALTER COLUMN capacity TYPE smallint;

ALTER TABLE class4.destinations DROP COLUMN test;
ALTER TABLE class4.dialpeers DROP COLUMN test;


set search_path TO class4;
DROP INDEX "routing_plan_static_routes_routing_plan_id_prefix_vendor_id_idx";
