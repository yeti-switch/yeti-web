begin;
insert into sys.version(number,comment) values(40,'LNP fix');

ALTER TABLE runtime_stats.gateways_stats DROP CONSTRAINT gateways_stats_gateway_id_fkey;
ALTER TABLE runtime_stats.dialpeers_stats DROP CONSTRAINT dialpeers_stats_dialpeer_id_fkey;
