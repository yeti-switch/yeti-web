begin;
insert into sys.version(number,comment) values(62,'Yet another static routing');

INSERT INTO class4.sortings VALUES(7,'Static only, No ACD&ASR control',null,true);
