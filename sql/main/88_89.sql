begin;
insert into sys.version(number,comment) values(89,'fix auth from domain');
...
update class4.gateways set auth_from_user = null where auth_from_user='';
update class4.gateways set auth_from_domain = null where auth_from_domain='';
commit;
