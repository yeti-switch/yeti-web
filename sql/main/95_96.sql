begin;
insert into sys.version(number,comment) values(96,'Check vendor for dialpeers');

-- DROP FUNCTION switch11.route(integer, integer, inet, integer, inet, integer, character varying, character varying, character varying, integer, character varying, character varying, integer, character varying, character varying, integer, character varying, character varying, character varying, character varying, inet, integer);

CREATE OR REPLACE FUNCTION switch11.route(
  i_node_id integer,
  i_pop_id integer,
  i_remote_ip inet,
