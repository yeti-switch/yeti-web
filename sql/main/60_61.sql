begin;
insert into sys.version(number,comment) values(61,'remove capacity default');

ALTER TABLE class4.customers_auth ALTER COLUMN capacity DROP DEFAULT ;
ALTER TABLE billing.accounts ALTER COLUMN origination_capacity DROP DEFAULT ;
ALTER TABLE billing.accounts ALTER COLUMN termination_capacity DROP DEFAULT ;
ALTER TABLE class4.dialpeers ALTER COLUMN capacity DROP DEFAULT ;
ALTER TABLE class4.gateways ALTER COLUMN termination_capacity DROP DEFAULT ;
