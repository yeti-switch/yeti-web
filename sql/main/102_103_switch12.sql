...
alter table class4.gateways
	add transport_protocol_id smallint not null REFERENCES class4.transport_protocols(id) default 1,
	add term_proxy_transport_protocol_id smallint not null REFERENCES class4.transport_protocols(id) default 1,
	add orig_proxy_transport_protocol_id smallint not null REFERENCES class4.transport_protocols(id) default 1;

alter table data_import.import_gateways
	add transport_protocol_id smallint,
	add term_proxy_transport_protocol_id smallint,
	add orig_proxy_transport_protocol_id smallint,
	add transport_protocol_name varchar,
	add term_proxy_transport_protocol_name varchar,
	add orig_proxy_transport_protocol_name varchar;
...
alter table class4.registrations
			add transport_protocol_id smallint not null REFERENCES class4.transport_protocols(id) default 1,
			add proxy_transport_protocol_id smallint not null REFERENCES class4.transport_protocols(id) default 1;
...
-- Started on 2017-03-30 23:34:02 EEST
...
--
-- TOC entry 37 (class 2615 OID 21967)
...
--
-- TOC entry 2510 (class 1247 OID 21970)
...
--
-- TOC entry 2513 (class 1247 OID 21973)
...
--
-- TOC entry 2516 (class 1247 OID 21976)
...
--
-- TOC entry 2519 (class 1247 OID 21979)
...
--
-- TOC entry 2522 (class 1247 OID 21982)
...
--
-- TOC entry 2525 (class 1247 OID 21985)
...
--
-- TOC entry 2528 (class 1247 OID 21988)
...
--
-- TOC entry 2559 (class 1247 OID 22110)
...
--
-- TOC entry 2562 (class 1247 OID 22145)
...
--
-- TOC entry 2531 (class 1247 OID 21991)
...
--
-- TOC entry 1352 (class 1255 OID 21992)
...
--
-- TOC entry 1353 (class 1255 OID 21993)
...
--
-- TOC entry 1361 (class 1255 OID 22141)
-- Name: debug(smallint, inet, integer, character varying, character varying, integer, character varying, character varying); Type: FUNCTION; Schema: switch12; Owner: -
--

CREATE FUNCTION debug(i_transport_protocol_id smallint, i_remote_ip inet, i_remote_port integer, i_src_prefix character varying, i_dst_prefix character varying, i_pop_id integer, i_uri_domain character varying, i_x_yeti_auth character varying) RETURNS SETOF callprofile52_ty
...
--
-- TOC entry 1354 (class 1255 OID 21995)
...
--
-- TOC entry 1355 (class 1255 OID 21996)
...
--
-- TOC entry 1356 (class 1255 OID 21997)
...
--
-- TOC entry 1357 (class 1255 OID 21998)
...
--
-- TOC entry 1326 (class 1255 OID 21999)
...
--
-- TOC entry 1327 (class 1255 OID 22000)
...
--
-- TOC entry 1328 (class 1255 OID 22001)
...
--
-- TOC entry 1329 (class 1255 OID 22002)
...
--
-- TOC entry 1330 (class 1255 OID 22003)
...
--
-- TOC entry 1331 (class 1255 OID 22004)
...
--
-- TOC entry 1332 (class 1255 OID 22005)
...
--
-- TOC entry 1333 (class 1255 OID 22006)
...
--
-- TOC entry 1334 (class 1255 OID 22007)
...
--
-- TOC entry 1335 (class 1255 OID 22008)
...
--
-- TOC entry 1345 (class 1255 OID 22009)
...
--
-- TOC entry 1346 (class 1255 OID 22010)
...
--
-- TOC entry 1342 (class 1255 OID 22011)
...
--
-- TOC entry 1372 (class 1255 OID 22191)
...
--
-- TOC entry 597 (class 1259 OID 22013)
...
--
-- TOC entry 1344 (class 1255 OID 22020)
...
--
-- TOC entry 1347 (class 1255 OID 22021)
...
--
-- TOC entry 1348 (class 1255 OID 22022)
...
--
-- TOC entry 1362 (class 1255 OID 22147)
-- Name: new_profile(); Type: FUNCTION; Schema: switch12; Owner: -
--

CREATE FUNCTION new_profile() RETURNS callprofile53_ty
    LANGUAGE plpgsql COST 10
    AS $_$
DECLARE
  v_ret switch12.callprofile53_ty;
BEGIN
...
--
-- TOC entry 1358 (class 1255 OID 22024)
...
--
-- TOC entry 1359 (class 1255 OID 22025)
...
--
-- TOC entry 1363 (class 1255 OID 22150)
-- Name: process_dp(callprofile53_ty, class4.destinations, class4.dialpeers, billing.accounts, class4.gateways, billing.accounts, integer, boolean, integer); Type: FUNCTION; Schema: switch12; Owner: -
--

CREATE FUNCTION process_dp(i_profile callprofile53_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_pop_id integer, i_send_billing_information boolean, i_max_call_length integer) RETURNS SETOF callprofile53_ty
...
--
-- TOC entry 1368 (class 1255 OID 22160)
-- Name: process_dp_debug(callprofile53_ty, class4.destinations, class4.dialpeers, billing.accounts, class4.gateways, billing.accounts, integer, boolean, integer); Type: FUNCTION; Schema: switch12; Owner: -
--

CREATE FUNCTION process_dp_debug(i_profile callprofile53_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_pop_id integer, i_send_billing_information boolean, i_max_call_length integer) RETURNS SETOF callprofile53_ty
    LANGUAGE plpgsql STABLE SECURITY DEFINER COST 10000
    AS $$
DECLARE
  /*dbg{*/
...
--
-- TOC entry 1369 (class 1255 OID 22161)
-- Name: process_dp_release(callprofile53_ty, class4.destinations, class4.dialpeers, billing.accounts, class4.gateways, billing.accounts, integer, boolean, integer); Type: FUNCTION; Schema: switch12; Owner: -
--

CREATE FUNCTION process_dp_release(i_profile callprofile53_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_pop_id integer, i_send_billing_information boolean, i_max_call_length integer) RETURNS SETOF callprofile53_ty
    LANGUAGE plpgsql STABLE SECURITY DEFINER COST 10000
    AS $$
DECLARE
...
--
-- TOC entry 1364 (class 1255 OID 22153)
-- Name: process_gw(callprofile53_ty, class4.destinations, class4.dialpeers, billing.accounts, class4.gateways, billing.accounts, class4.gateways, boolean, integer); Type: FUNCTION; Schema: switch12; Owner: -
--

CREATE FUNCTION process_gw(i_profile callprofile53_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_vendor_gw class4.gateways, i_send_billing_information boolean, i_max_call_length integer) RETURNS callprofile53_ty
...
--
-- TOC entry 1370 (class 1255 OID 22162)
-- Name: process_gw_debug(callprofile53_ty, class4.destinations, class4.dialpeers, billing.accounts, class4.gateways, billing.accounts, class4.gateways, boolean, integer); Type: FUNCTION; Schema: switch12; Owner: -
--

CREATE FUNCTION process_gw_debug(i_profile callprofile53_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_vendor_gw class4.gateways, i_send_billing_information boolean, i_max_call_length integer) RETURNS callprofile53_ty
    LANGUAGE plpgsql STABLE SECURITY DEFINER COST 100000
    AS $_$
DECLARE
  i integer;
...
--
-- TOC entry 1371 (class 1255 OID 22164)
-- Name: process_gw_release(callprofile53_ty, class4.destinations, class4.dialpeers, billing.accounts, class4.gateways, billing.accounts, class4.gateways, boolean, integer); Type: FUNCTION; Schema: switch12; Owner: -
--

CREATE FUNCTION process_gw_release(i_profile callprofile53_ty, i_destination class4.destinations, i_dp class4.dialpeers, i_customer_acc billing.accounts, i_customer_gw class4.gateways, i_vendor_acc billing.accounts, i_vendor_gw class4.gateways, i_send_billing_information boolean, i_max_call_length integer) RETURNS callprofile53_ty
    LANGUAGE plpgsql STABLE SECURITY DEFINER COST 100000
    AS $_$
DECLARE
  i integer;
...
--
-- TOC entry 1360 (class 1255 OID 22035)
...
--
-- TOC entry 1365 (class 1255 OID 22148)
...
CREATE FUNCTION route(i_node_id integer, i_pop_id integer, i_protocol_id smallint, i_remote_ip inet, i_remote_port integer, i_local_ip inet, i_local_port integer, i_from_dsp character varying, i_from_name character varying, i_from_domain character varying, i_from_port integer, i_to_name character varying, i_to_domain character varying, i_to_port integer, i_contact_name character varying, i_contact_domain character varying, i_contact_port integer, i_uri_name character varying, i_uri_domain character varying, i_x_yeti_auth character varying, i_diversion character varying, i_x_orig_ip inet, i_x_orig_port integer, i_x_orig_protocol_id smallint) RETURNS SETOF callprofile53_ty
    LANGUAGE plpgsql SECURITY DEFINER ROWS 10
    AS $$
DECLARE
  v_ret switch12.callprofile53_ty;
...
--
-- TOC entry 1366 (class 1255 OID 22156)
...
CREATE FUNCTION route_debug(i_node_id integer, i_pop_id integer, i_protocol_id smallint, i_remote_ip inet, i_remote_port integer, i_local_ip inet, i_local_port integer, i_from_dsp character varying, i_from_name character varying, i_from_domain character varying, i_from_port integer, i_to_name character varying, i_to_domain character varying, i_to_port integer, i_contact_name character varying, i_contact_domain character varying, i_contact_port integer, i_uri_name character varying, i_uri_domain character varying, i_x_yeti_auth character varying, i_diversion character varying, i_x_orig_ip inet, i_x_orig_port integer, i_x_orig_protocol_id smallint) RETURNS SETOF callprofile53_ty
    LANGUAGE plpgsql SECURITY DEFINER ROWS 10
    AS $$
DECLARE
  v_ret switch12.callprofile53_ty;
...
--
-- TOC entry 1367 (class 1255 OID 22158)
...
CREATE FUNCTION route_release(i_node_id integer, i_pop_id integer, i_protocol_id smallint, i_remote_ip inet, i_remote_port integer, i_local_ip inet, i_local_port integer, i_from_dsp character varying, i_from_name character varying, i_from_domain character varying, i_from_port integer, i_to_name character varying, i_to_domain character varying, i_to_port integer, i_contact_name character varying, i_contact_domain character varying, i_contact_port integer, i_uri_name character varying, i_uri_domain character varying, i_x_yeti_auth character varying, i_diversion character varying, i_x_orig_ip inet, i_x_orig_port integer, i_x_orig_protocol_id smallint) RETURNS SETOF callprofile53_ty
    LANGUAGE plpgsql SECURITY DEFINER ROWS 10
    AS $$
DECLARE
  v_ret switch12.callprofile53_ty;
...
--
-- TOC entry 1302 (class 1255 OID 22042)
...
--
-- TOC entry 1303 (class 1255 OID 22043)
...
--
-- TOC entry 598 (class 1259 OID 22044)
...
--
-- TOC entry 599 (class 1259 OID 22046)
...
--
-- TOC entry 600 (class 1259 OID 22052)
...
--
-- TOC entry 601 (class 1259 OID 22054)
...
--
-- TOC entry 602 (class 1259 OID 22056)
...
--
-- TOC entry 603 (class 1259 OID 22063)
...
--
-- TOC entry 604 (class 1259 OID 22065)
...
--
-- TOC entry 605 (class 1259 OID 22073)
...
--
-- TOC entry 606 (class 1259 OID 22079)
...
--
-- TOC entry 3996 (class 2604 OID 22081)
...
--
-- TOC entry 3998 (class 2604 OID 22082)
-- Name: id; Type: DEFAULT; Schema: switch12; Owner: -
--
...
--
-- TOC entry 4001 (class 2604 OID 22083)
-- Name: id; Type: DEFAULT; Schema: switch12; Owner: -
--
...
-- Dependencies: 598
-- Name: events_id_seq; Type: SEQUENCE SET; Schema: switch12; Owner: -
--
...
--
-- TOC entry 4132 (class 0 OID 22046)
-- Dependencies: 599
-- Data for Name: resource_action; Type: TABLE DATA; Schema: switch12; Owner: -
--
...
--
-- TOC entry 4130 (class 0 OID 22013)
-- Dependencies: 597
-- Data for Name: resource_type; Type: TABLE DATA; Schema: switch12; Owner: -
--
...
-- Dependencies: 600
-- Name: resource_type_id_seq; Type: SEQUENCE SET; Schema: switch12; Owner: -
--
...
-- Dependencies: 601
-- Name: switch_in_interface_id_seq; Type: SEQUENCE SET; Schema: switch12; Owner: -
--

SELECT pg_catalog.setval('switch_in_interface_id_seq', 5, true);


--
-- TOC entry 4150 (class 0 OID 0)
-- Dependencies: 603
-- Name: switch_interface_id_seq; Type: SEQUENCE SET; Schema: switch12; Owner: -
--

SELECT pg_catalog.setval('switch_interface_id_seq', 920, true);


--
-- TOC entry 4137 (class 0 OID 22065)
-- Dependencies: 604
-- Data for Name: switch_interface_in; Type: TABLE DATA; Schema: switch12; Owner: -
--
...
--
-- TOC entry 4135 (class 0 OID 22056)
-- Dependencies: 602
-- Data for Name: switch_interface_out; Type: TABLE DATA; Schema: switch12; Owner: -
--
...
--
-- TOC entry 4138 (class 0 OID 22073)
-- Dependencies: 605
-- Data for Name: trusted_headers; Type: TABLE DATA; Schema: switch12; Owner: -
--
...
-- Dependencies: 606
-- Name: trusted_headers_id_seq; Type: SEQUENCE SET; Schema: switch12; Owner: -
--
...
--
-- TOC entry 4007 (class 2606 OID 22085)
...
--
-- TOC entry 4009 (class 2606 OID 22087)
...
--
-- TOC entry 4003 (class 2606 OID 22089)
...
--
-- TOC entry 4005 (class 2606 OID 22091)
...
--
-- TOC entry 4015 (class 2606 OID 22093)
...
--
-- TOC entry 4017 (class 2606 OID 22095)
...
--
-- TOC entry 4011 (class 2606 OID 22097)
...
--
-- TOC entry 4013 (class 2606 OID 22099)
...
--
-- TOC entry 4019 (class 2606 OID 22101)
...
--
-- TOC entry 4020 (class 2606 OID 22102)
...
-- Completed on 2017-03-30 23:34:06 EEST
