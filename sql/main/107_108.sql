...
alter table class4.numberlist_items
  add column src_rewrite_rule varchar,
  add column src_rewrite_result varchar,
  add column dst_rewrite_rule varchar,
  add column dst_rewrite_result VARCHAR;

alter table class4.numberlists
  add column default_src_rewrite_rule varchar,
  add column default_src_rewrite_result varchar,
  add column default_dst_rewrite_rule varchar,
  add column default_dst_rewrite_result VARCHAR;
