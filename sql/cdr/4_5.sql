begin;
insert into sys.version(number,comment) values(5,'Additional rtp counters in CDR');

ALTER TABLE cdr.cdr 
 ADD COLUMN lega_rx_decode_errs INTEGER,
 ADD COLUMN lega_rx_no_buf_errs INTEGER,
 ADD COLUMN lega_rx_parse_errs INTEGER,
 ADD COLUMN legb_rx_decode_errs INTEGER,
 ADD COLUMN legb_rx_no_buf_errs INTEGER,
 ADD COLUMN legb_rx_parse_errs INTEGER;

CREATE OR REPLACE FUNCTION switch.writecdr(
i_is_master boolean, i_node_id integer, i_pop_id integer, i_routing_attempt integer, i_is_last_cdr boolean, i_time_limit integer, i_lega_local_ip character varying, i_lega_local_port integer, i_lega_remote_ip character varying, i_lega_remote_port integer, i_legb_local_ip character varying, i_legb_local_port integer, i_legb_remote_ip character varying, i_legb_remote_port integer, i_time_start bigint, i_time_connect bigint, i_time_end bigint, i_legb_disconnect_code integer, i_legb_disconnect_reason character varying, i_disconnect_initiator integer, i_internal_disconnect_code integer, i_internal_disconnect_reason character varying, i_lega_disconnect_code integer, i_lega_disconnect_reason character varying, i_orig_call_id character varying, i_term_call_id character varying, i_local_tag character varying, i_msg_logger_path character varying, i_dump_level_id integer, 
i_lega_rx_payloads character varying, 
i_lega_tx_payloads character varying,
i_legb_rx_payloads character varying,
i_legb_tx_payloads character varying,
i_lega_rx_bytes integer,
i_lega_tx_bytes integer,
i_legb_rx_bytes integer,
i_legb_tx_bytes integer,
i_lega_rx_decode_errs integer,
i_lega_rx_no_buf_errs integer,
i_lega_rx_parse_errs integer,
i_legb_rx_decode_errs integer,
i_legb_rx_no_buf_errs integer,
i_legb_rx_parse_errs integer,
...
v_cdr.lega_rx_decode_errs:=i_lega_rx_decode_errs;
v_cdr.lega_rx_no_buf_errs:=i_lega_rx_no_buf_errs;
v_cdr.lega_rx_parse_errs:=i_lega_rx_parse_errs;
v_cdr.legb_rx_decode_errs:=i_legb_rx_decode_errs;
v_cdr.legb_rx_no_buf_errs:=i_legb_rx_no_buf_errs;
v_cdr.legb_rx_parse_errs:=i_legb_rx_parse_errs;
