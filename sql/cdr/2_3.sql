begin;
insert into sys.version(number,comment) values(3,'Country/Network prefixes');

alter table cdr.cdr add dst_country_id integer;
alter table cdr.cdr add dst_network_id integer;
