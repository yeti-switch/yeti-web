begin;
insert into sys.version(number,comment) values(6,'JSON serialization for  rtp counters. Need for switch version >= 138');

drop type if exists switch.rtp_stats_data_ty;
