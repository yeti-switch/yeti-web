begin;
insert into sys.version(number,comment) values(9,'Writing exteneded call statistic');
...
alter table cdr.cdr
add routing_delay float,
add pdd float,
add rtt float,
add early_media_present boolean;
