begin;
insert into sys.version(number,comment) values(29,'CDR timing fixes');


ALTER TYPE switch.time_data_ty RENAME ATTRIBUTE leg_b_time_start TO leg_b_time;
...
ALTER TABLE cdr.cdr DROP COLUMN dump_file ;
ALTER TABLE cdr.cdr_archive DROP COLUMN dump_file ;
