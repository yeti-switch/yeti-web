begin;
insert into sys.version(number,comment) values(27,'New CDR writing');

CREATE TYPE switch.time_data_ty AS (
  time_start double precision,
  leg_b_time_start double precision,
...
v_cdr.routing_delay=(v_time_data.leg_b_time_start-v_time_data.time_start)::real;
v_cdr.pdd=(coalesce(v_time_data.time_18x,v_time_data.time_connect)-v_time_data.time_start)::real;
v_cdr.rtt=(coalesce(v_time_data.time_1xx,v_time_data.time_18x,v_time_data.time_connect)-v_time_data.leg_b_time_start)::real;
