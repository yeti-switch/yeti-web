...
RSpec.resource 'OutgoingNumberlist', document: :customer_v1 do
  ...
  get '/api/rest/customer/v1/outgoing-numberlists' do
    jsonapi_filters Api::Rest::Customer::V1::OutgoingNumberlistResource._allowed_filters
  ...
  get '/api/rest/customer/v1/outgoing-numberlists/:id' do
    let(:id) { nl.reload.id }
