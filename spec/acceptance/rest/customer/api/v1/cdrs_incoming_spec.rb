...
RSpec.resource 'CdrsIncoming', document: :customer_v1 do
  ...
  get '/api/rest/customer/v1/cdrs-incoming/:id' do
  ...
  get '/api/rest/customer/v1/cdrs-incoming/:id/rec' do
