...
resource 'Invoice period' do
  ...
  get '/api/rest/private/billing/invoice-period' do
    before do
  ...
  get '/api/rest/private/billing/invoice-period/:id' do
  ...
  post '/api/rest/private/billing/invoice-period' do
  ...
  put '/api/rest/private/billing/invoice-period/:id' do
    parameter :type, 'Resource type (invoice-periods)', scope: :data, required: true
  ...
  delete '/api/rest/private/billing/invoice-period/:id' do
    let(:id) { Billing::InvoicePeriod.create(name: 'Weekly').id }
