...
resource 'Auth profiles' do
  ...
  get '/api/rest/private/equipment/radius/auth-profiles' do
  ...
  get '/api/rest/private/equipment/radius/auth-profiles/:id' do
  ...
  post '/api/rest/private/equipment/radius/auth-profiles' do
  ...
  put '/api/rest/private/equipment/radius/auth-profiles/:id' do
    parameter :type, 'Resource type (auth-profiles)', scope: :data, required: true
  ...
  delete '/api/rest/private/equipment/radius/auth-profiles/:id' do
    let(:id) { create(:auth_profile).id }
