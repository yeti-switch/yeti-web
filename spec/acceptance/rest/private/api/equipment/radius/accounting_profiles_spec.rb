...
resource 'Accounting profiles' do
  ...
  get '/api/rest/private/equipment/radius/accounting-profiles' do
  ...
  get '/api/rest/private/equipment/radius/accounting-profiles/:id' do
  ...
  post '/api/rest/private/equipment/radius/accounting-profiles' do
  ...
  put '/api/rest/private/equipment/radius/accounting-profiles/:id' do
    parameter :type, 'Resource type (accounting_profiles)', scope: :data, required: true
  ...
  delete '/api/rest/private/equipment/radius/accounting-profiles/:id' do
    let(:id) { create(:accounting_profile).id }
