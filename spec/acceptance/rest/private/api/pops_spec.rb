...
resource 'Pops' do
  ...
  get '/api/rest/private/pops/:id' do
  ...
  put '/api/rest/private/pops/:id' do
    parameter :type, 'Resource type (pops)', scope: :data, required: true
  ...
  delete '/api/rest/private/pops/:id' do
    let(:id) { Pop.create(name: 'first').id }
