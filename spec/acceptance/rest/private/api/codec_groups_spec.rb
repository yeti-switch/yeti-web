...
resource 'Codec groups' do
  ...
  get '/api/rest/private/codec-groups' do
  ...
  get '/api/rest/private/codec-groups/:id' do
  ...
  post '/api/rest/private/codec-groups' do
  ...
  put '/api/rest/private/codec-groups/:id' do
    parameter :type, 'Resource type (codec-groups)', scope: :data, required: true
  ...
  delete '/api/rest/private/codec-groups/:id' do
    let(:id) { create(:codec_group).id }
