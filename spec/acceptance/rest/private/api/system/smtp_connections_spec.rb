...
resource 'Smtp connections' do
  ...
  get '/api/rest/private/system/smtp-connections' do
  ...
  get '/api/rest/private/system/smtp-connections/:id' do
  ...
  post '/api/rest/private/system/smtp-connections' do
  ...
  put '/api/rest/private/system/smtp-connections/:id' do
    parameter :type, 'Resource type (smtp-connections)', scope: :data, required: true
  ...
  delete '/api/rest/private/system/smtp-connections/:id' do
    let(:id) { create(:smtp_connection).id }
