...
RSpec.resource 'Sip options prober' do
  ...
  get '/api/rest/admin/sip-options-probers' do
    jsonapi_filters Api::Rest::Admin::SipOptionsProberResource._allowed_filters
  ...
  get '/api/rest/admin/sip-options-probers/:id' do
  ...
  post '/api/rest/admin/sip-options-probers' do
  ...
  put '/api/rest/admin/sip-options-probers/:id' do
    parameter :type, 'Resource type (sip-options-probers)', scope: :data, required: true
  ...
  delete '/api/rest/admin/sip-options-probers/:id' do
    let(:id) { create(:sip_options_prober).id }
