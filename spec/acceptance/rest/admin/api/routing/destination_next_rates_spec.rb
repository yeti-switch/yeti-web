...
RSpec.resource 'Destination next rates' do
  ...
  get '/api/rest/admin/routing/destination-next-rates' do
    jsonapi_filters Api::Rest::Admin::Routing::DestinationNextRateResource._allowed_filters
  ...
  get '/api/rest/admin/routing/destination-next-rates/:id' do
  ...
  post '/api/rest/admin/routing/destination-next-rates' do
  ...
  put '/api/rest/admin/routing/destination-next-rates/:id' do
    parameter :type, 'Resource type (destinations-next-rates)', scope: :data, required: true
  ...
  delete '/api/rest/admin/routing/destination-next-rates/:id' do
