...
RSpec.describe Equipment::Registration, type: :model do
  it do
    is_expected.to validate_numericality_of(:retry_delay).is_less_than_or_equal_to(ApplicationRecord::PG_MAX_SMALLINT)
    is_expected.to validate_numericality_of(:max_attempts).is_less_than_or_equal_to(ApplicationRecord::PG_MAX_SMALLINT)
  end
end
