...
RSpec.describe Report::Realtime::BadRouting, '.time_interval_eq' do
  ...
  context 'record created now' do
    let!(:record) { FactoryBot.create :bad_routing, :with_id, time_start: Time.now }
  ...
  context 'record created 30 seconds ago' do
    let!(:record) { FactoryBot.create :bad_routing, :with_id, time_start: 30.seconds.ago }
  ...
  context 'record created 61 seconds ago' do
    let!(:record) { FactoryBot.create :bad_routing, :with_id, time_start: 61.seconds.ago }
  ...
  context 'record created 90 seconds ago' do
    let!(:record) { FactoryBot.create :bad_routing, :with_id, time_start: 90.seconds.ago }
  ...
  context 'record created 110 seconds ago' do
    let!(:record) { FactoryBot.create :bad_routing, :with_id, time_start: 110.seconds.ago }
  ...
  context 'record created 115 seconds ago' do
    let!(:record) { FactoryBot.create :bad_routing, :with_id, time_start: 115.seconds.ago }
  ...
  context 'record created 130 seconds ago' do
    let!(:record) { FactoryBot.create :bad_routing, :with_id, time_start: 130.seconds.ago }
  ...
  context 'with time interval 3600' do
    ...
    context 'record created 1 hour and 1 second ago' do
      let!(:record) { FactoryBot.create :bad_routing, :with_id, time_start: 3601.seconds.ago }
