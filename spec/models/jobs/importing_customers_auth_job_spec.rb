...
RSpec.describe 'Importing::CustomersAuth => CustomersAuth delayed_job' do
  it_behaves_like 'Jobs for importing data' do
    ...
    it 'creates Normalized copyes' do
      expect { run_jobs }.to change { CustomersAuthNormalized.count }.by(128)
    end
  end
end
