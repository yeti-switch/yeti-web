...
RSpec.describe 'switch.writecdr()' do
  ...
  let(:i_lega_request_headers) do
    {
      ...
      "diversion": ['rspec-diversion-in'],
      "p_asserted_identity": ['rspec-pai-in'],
  ...
  let(:i_legb_request_headers) do
    {
      ...
      "diversion": ['rspec-diversion-out'],
      "p_asserted_identity": ['rspec-pai-out'],
      "p_preferred_identity": 'rspec-ppi-out',
      "privacy": ['rspec-privacy-out'],
      "remote_party_id": ['rspec-rpid-out'],
      "rpid_privacy": ['rspec-rpid-privacy-out']
    }.to_json
  end
  ...
  let(:i_internal_disconnect_code_id) { 221 }
