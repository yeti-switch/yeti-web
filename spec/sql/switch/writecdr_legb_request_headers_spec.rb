...
RSpec.describe 'switch.writecdr()' do
  ...
  let(:i_dynamic_fields) do
    {
      ...
      "src_country_id": 111,
      "src_network_id": 333,
      "src_network_type_id": 11,
      "dst_country_id": 222,
      "dst_network_id": 1533,
      "dst_network_type_id": 12,
  ...
  let(:i_lega_request_headers) do
    {
      "v_test1": 'sip:p-charge-info@example.com/uri',
      "p_charge_info": 'sip:p-charge-info@example.com/uri',
      "reason": {
        "q850_cause": 16,
        "q850_text": 'Normal call clearing',
        "q850_params": 'sparam1; sparam2=test; sparam3=test'
      },
      "diversion": %w[rspec-diversion-in1 rspec-diversion-in2],
      "p_asserted_identity": %w[rspec-pai-in1 rspec-pai-in2],
      "p_preferred_identity": 'rspec-ppi-in',
      "privacy": %w[rspec-privacy-in1 rspec-privacy-in2],
      "remote_party_id": %w[rspec-rpid-in1 rspec-rpid-in2],
      "rpid_privacy": %w[rspec-rpid-privacy-in1 rspec-rpid-privacy-in2]
    }.to_json
  end

  let(:i_legb_request_headers) do
    {
      "v_test2": 'sip:p-charge-info@example.com/uri',
      "diversion": %w[rspec-diversion-out1 rspec-diversion-out2],
      "p_asserted_identity": %w[rspec-pai-out1 rspec-pai-out2],
      "p_preferred_identity": 'rspec-ppi-out',
      "privacy": %w[rspec-privacy-out1 rspec-privacy-out2],
      "remote_party_id": %w[rspec-rpid-out1 rspec-rpid-out2],
      "rpid_privacy": %w[rspec-rpid-privacy-out1 rspec-rpid-privacy-out2]
    }.to_json
  end

  let(:i_legb_reply_headers) do
    {
      "v_test3": 'sip:p-charge-info@example.com/uri',
      "reason": {
        "q850_cause": 32,
        "q850_text": 'test',
        "q850_params": 'sparam1'
  ...
  it 'creates CDR with expected attributes' do
    ...
    expect(cdr).to have_attributes(
                     ...
                     src_name_in: '',
                     src_name_out: '',
                     diversion_in: 'rspec-diversion-in1,rspec-diversion-in2',
                     diversion_out: 'rspec-diversion-out1,rspec-diversion-out2',
                     ...
                     uuid: kind_of(String),
                     pai_in: 'rspec-pai-in1,rspec-pai-in2',
                     ppi_in: 'rspec-ppi-in',
                     privacy_in: 'rspec-privacy-in1,rspec-privacy-in2',
                     rpid_in: 'rspec-rpid-in1,rspec-rpid-in2',
                     rpid_privacy_in: 'rspec-rpid-privacy-in1,rspec-rpid-privacy-in2',
                     pai_out: 'rspec-pai-out1,rspec-pai-out2',
                     ppi_out: 'rspec-ppi-out',
                     privacy_out: 'rspec-privacy-out1,rspec-privacy-out2',
                     rpid_out: 'rspec-rpid-out1,rspec-rpid-out2',
                     rpid_privacy_out: 'rspec-rpid-privacy-out1,rspec-rpid-privacy-out2',
