...
RSpec.describe Api::Rest::Admin::InvoiceOriginatedDestinationsController, type: :request, bullet: [:n] do
  include_context :json_api_admin_helpers, type: :'invoice-originated-destinations'
