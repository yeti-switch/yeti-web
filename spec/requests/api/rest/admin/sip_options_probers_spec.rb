...
RSpec.describe Api::Rest::Admin::SipOptionsProbersController do
  include_context :json_api_admin_helpers, type: :'sip-options-probers'
  ...
  shared_examples :responds_jsonapi_sip_options_prober do
    it 'responds with correct data' do
      ...
      expect(response_json[:data]).to have_jsonapi_attributes(
          ...
          'route-set': sip_options_prober.route_set,
  ...
  describe 'GET /api/rest/admin/sip-options-probers' do
    subject do
  ...
  describe 'GET /api/rest/admin/sip-options-probers/:id' do
    subject do
    ...
    context 'with include pop,transport-protocol,node' do
  ...
  describe 'POST /api/rest/admin/sip-oprions-probers' do
    subject do
  ...
  describe 'PATCH /api/rest/admin/sip-options-probers/:id' do
    subject do
  ...
  describe 'DELETE /api/rest/admin/sip-options-probers/:id' do
    subject do
