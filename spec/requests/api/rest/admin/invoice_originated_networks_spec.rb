...
RSpec.describe Api::Rest::Admin::InvoiceOriginatedNetworksController, type: :request, bullet: [:n] do
  include_context :json_api_admin_helpers, type: :'invoice-originated-networks'
