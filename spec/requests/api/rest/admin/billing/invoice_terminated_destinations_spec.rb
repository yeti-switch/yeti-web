...
RSpec.describe Api::Rest::Admin::Billing::InvoiceTerminatedDestinationsController, type: :request, bullet: [:n] do
  include_context :json_api_admin_helpers, type: :'invoice-terminated-destinations', prefix: 'billing'
