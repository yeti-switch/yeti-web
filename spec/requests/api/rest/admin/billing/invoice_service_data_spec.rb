...
RSpec.describe Api::Rest::Admin::Billing::InvoiceServiceDataController, type: :request, bullet: [:n] do
  include_context :json_api_admin_helpers, type: :'invoice-service-data', prefix: 'billing'
