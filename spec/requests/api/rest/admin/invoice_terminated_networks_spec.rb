...
RSpec.describe Api::Rest::Admin::InvoiceTerminatedNetworksController, type: :request, bullet: [:n] do
  include_context :json_api_admin_helpers, type: :'invoice-terminated-networks'
