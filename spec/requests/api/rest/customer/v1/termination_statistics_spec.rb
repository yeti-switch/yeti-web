...
RSpec.describe Api::Rest::Customer::V1::TerminationStatisticsController, type: :request do
  ...
  describe 'GET /api/rest/customer/v1/termination-statistics' do
    subject do
      get '/api/rest/customer/v1/termination-statistics', params: query, headers: auth_headers
    end
    ...
    let(:clickhouse_query) do
      "
          ...
          FROM cdrs
          WHERE vendor_acc_id = {account_id: UInt32}
      ...
      let(:clickhouse_query) do
        "
          ...
          WHERE vendor_acc_id = {account_id: UInt32}
            ...
            AND vendor_price = {vendor_price_eq: Float64}
            AND vendor_price > {vendor_price_gt: Float64}
            AND vendor_price < {vendor_price_lt: Float64}
          GROUP BY t
          WITH TOTALS
          ORDER BY t
          FORMAT JSONColumnsWithMetadata
