...
RSpec.describe Api::Rest::Customer::V1::TerminationStatisticsQualityController do
  ...
  describe 'GET /api/rest/customer/v1/termination-statistics-quality' do
    subject { get '/api/rest/customer/v1/termination-statistics-quality', params: query, headers: auth_headers }
