...
RSpec.describe Api::Rest::Customer::V1::TerminationStatisticsQualityController, type: :request do
  include_context :customer_termination_statistics_quality_clickhouse_helpers
  ...
  describe 'GET /api/rest/customer/v1/termination-statistics-quality' do
    subject do
      get '/api/rest/customer/v1/termination-statistics-quality', params: query, headers: auth_headers
    end
    ...
    context 'with all allowed params' do
      let(:query) do
        super().merge(
          ...
          'duration-gt': 9,
          'duration-lt': 11,
          'vendor-price-eq': '5.55',
          'vendor-price-gt': '5.54',
          'vendor-price-lt': '5.56',
          sampling: 'minute'
        )
      end
      let(:clickhouse_query_sql_where_conditions) do
        [
          *super(),
          ...
          'vendor_price = {vendor_price_eq: Float64}',
          'vendor_price > {vendor_price_gt: Float64}',
          'vendor_price < {vendor_price_lt: Float64}'
        ]
      end
      let(:clickhouse_query_params) do
        super().merge(
          ...
          param_vendor_price_eq: query[:'vendor-price-eq'],
          param_vendor_price_gt: query[:'vendor-price-gt'],
          param_vendor_price_lt: query[:'vendor-price-lt']
        )
      end
