      ...
      expect(response_data).to match(
        hash_including(
          ...
          'attributes' => {
            ...
            'rateplan-id' => cdr.rateplan_id,
            'destination-id' => cdr.destination_id,
            'destination-next-rate' => cdr.destination_next_rate.to_s,
            'destination-fee' => cdr.destination_fee.to_s,
            'routing-group-id'=> cdr.routing_group_id,
            'routing-plan-id'=> cdr.routing_plan_id,
            'dialpeer-id' => cdr.dialpeer_id,
            ...
            'customer-auth-id' => cdr.customer_auth_id,
            'customer-auth-external-id' => cdr.customer_auth_external_id,
            'customer-acc-id' => cdr.customer_acc_id,
