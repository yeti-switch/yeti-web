...
RSpec.describe Api::Rest::Admin::AuthLogsController, type: :controller do
  ...
  describe 'GET index with ransack filters' do
    ...
    it_behaves_like :jsonapi_filters_by_inet_field, :origination_ip
    ...
    it_behaves_like :jsonapi_filters_by_inet_field, :transport_remote_ip
    it_behaves_like :jsonapi_filters_by_number_field, :transport_remote_port, type: :number
    it_behaves_like :jsonapi_filters_by_inet_field, :transport_local_ip
  ...
  describe 'POST create' do
    it 'POST should not be routable', type: :routing do
      expect(post: '/api/rest/admin/auth_logs').to_not be_routable
    end
  end

  describe 'PATCH create' do
    it 'PATCH should not be routable', type: :routing do
      expect(patch: '/api/rest/admin/auth_logs/123').to_not be_routable
    end
  end

  describe 'DELETE create' do
    it 'DELETE should not be routable', type: :routing do
      expect(delete: '/api/rest/admin/auth_logs/123').to_not be_routable
    end
  end
end
