...
RSpec.describe 'Index Report Realtime Origination Performance' do
  ...
  it 'n+1 checks' do
    origination_performances = create_list(:realtime_origination_performance, 2,
                                            customer: customer,
    ...
    visit report_realtime_origination_performances_path
    origination_performances.each do |td|
