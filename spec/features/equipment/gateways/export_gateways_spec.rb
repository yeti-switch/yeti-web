  ...
  it 'has expected header and values' do
    expect(subject).to match_array(
      [
        ...
        ['Orig force route set',               item.orig_force_route_set.to_s],
        ['Orig route set',                     item.orig_route_set.to_s],
        ...
        ['Term force route set',               item.term_force_route_set.to_s],
        ['Term route set',                     item.term_route_set.to_s],
        ...
        ['Contact user',                       item.contact_user.to_s],
        ...
        ['Ice mode name',                      item.ice_mode_name],
        ['Rtcp mux mode name',                 item.rtcp_mux_mode_name],
        ['Rtcp feedback mode name',            item.rtcp_feedback_mode_name],
