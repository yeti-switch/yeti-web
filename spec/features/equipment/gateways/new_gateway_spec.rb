...
RSpec.describe 'Create new Gateway', type: :feature, js: true do
  ...
  let(:fill_form!) do
    ...
    fill_in_tom_select 'Termination SRC Numberlist', with: termination_src_numberlist.display_name, search: true
    fill_in_tom_select 'Termination DST Numberlist', with: termination_dst_numberlist.display_name, search: true
  end
  let(:submit_form!) do
