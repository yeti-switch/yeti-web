...
RSpec.describe 'Create new Gateway', type: :feature, js: true do
  ...
  context 'validate autogenerated credentials' do
    ...
    it 'should autogenerate credential for :incoming_auth_username with 20 chars' do
    ...
    it 'should autogenerate credential for :incoming_auth_password with 20 chars' do
