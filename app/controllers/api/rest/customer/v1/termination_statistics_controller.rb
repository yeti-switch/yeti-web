...
class Api::Rest::Customer::V1::TerminationStatisticsController < Api::RestController
  ...
  def show
    statistic = ClickhouseReport::TerminationStatistic.new(params.to_unsafe_h, auth_context:)
