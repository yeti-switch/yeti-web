...
class Api::Rest::Customer::V1::TerminationStatisticsQualityController < Api::RestController
  ...
  def show
    statistic = ClickhouseReport::TerminationStatisticQuality.new(params.to_unsafe_h, auth_context:)
