...
class Api::Rest::Customer::V1::OriginationStatisticsQualityController < Api::RestController
  ...
  def show
    statistic = ClickhouseReport::OriginationStatisticQuality.new(params.to_unsafe_h, auth_context:)
