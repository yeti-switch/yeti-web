...
class Api::Rest::Customer::V1::OriginationActiveCallsController < Api::RestController
  ...
  def show
    statistic = ClickhouseReport::OriginationActiveCalls.new(params.to_unsafe_h, auth_context:)
