...
class CdrExport < Yeti::ActiveRecord
  ...
  ALLOWED_FILTERS = [
    'time_start_lteq'.freeze,
    'time_start_gteq'.freeze,
    'success_eq'.freeze,
    'customer_auth_external_id_eq'.freeze,
    'failed_resource_type_id_eq'.freeze,
    'src_prefix_in_contains'.freeze,
    'dst_prefix_in_contains'.freeze,
    'src_prefix_routing_contains'.freeze,
    'dst_prefix_routing_contains'.freeze,
    'customer_acc_external_id_eq'.freeze,
    'is_last_cdr_eq'.freeze
  ].freeze
  #any cdr columns
