...
#  rx_inbound_dtmf_filtering_mode_id   :integer
#  rx_inbound_dtmf_filtering_mode_name :string
#  tx_inbound_dtmf_filtering_mode_id   :integer
#  tx_inbound_dtmf_filtering_mode_name :string
#  weight                              :integer
#
...
class Importing::Gateway  < Importing::Base
  ...
  belongs_to :rx_inbound_dtmf_filtering_mode, class_name: '::Equipment::GatewayInboundDtmfFilteringMode', foreign_key: :rx_inbound_dtmf_filtering_mode_id
  belongs_to :tx_inbound_dtmf_filtering_mode, class_name: '::Equipment::GatewayInboundDtmfFilteringMode', foreign_key: :tx_inbound_dtmf_filtering_mode_id
  ...
  self.import_attributes = [
      ...
      'tx_inbound_dtmf_filtering_mode_id', 'rx_inbound_dtmf_filtering_mode_id',
