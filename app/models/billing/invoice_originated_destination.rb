...
# Indexes
#
#  invoice_originated_destinations_invoice_id_idx  (invoice_id)
#
# Foreign Keys
#
#  invoice_originated_destinations_invoice_id_fkey  (invoice_id => invoices.id)
#

class Billing::InvoiceOriginatedDestination < Cdr::Base
  self.table_name = 'billing.invoice_originated_destinations'
