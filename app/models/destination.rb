...
#  dp_margin_fixed        :decimal(, )      default("0"), not null
#  dp_margin_percent      :decimal(, )      default("0"), not null
...
#  external_id            :integer
#  asr_limit              :float            default("0"), not null
#  acd_limit              :float            default("0"), not null
#  short_calls_limit      :float            default("0"), not null
