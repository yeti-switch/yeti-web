...
module Jobs
  class DeleteExpiredDialpeers < ::BaseJob
    ...
    def expired_date
      ...
      keep_expired_dialpeers_days = Rails.configuration[:keep_expired_dialpeers_days]
      @expired_date ||= keep_expired_dialpeers_days.days.ago if keep_expired_dialpeers_days.present?
    end
  end
end
