class Api::Rest::Private::GatewayResource < JSONAPI::Resource
  attributes :name, :enabled, :priority, :acd_limit, :asr_limit, :contractor_id, :sdp_alines_filter_type_id,
             :codec_group_id, :sdp_c_location_id, :sensor_level_id, :dtmf_receive_mode_id, :dtmf_send_mode_id,
             :rel100_mode_id, :session_refresh_method_id, :transport_protocol_id, :term_proxy_transport_protocol_id,
             :orig_proxy_transport_protocol_id,
             :gateway_group_id, :pop_id, :allow_origination, :allow_termination, :sst_enabled, :sensor_id, :host, :port,
             :resolve_ruri, :diversion_policy_id, :diversion_rewrite_rule, :diversion_rewrite_result,
