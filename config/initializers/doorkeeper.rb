...
# Skip Doorkeeper configuration when OAuth is disabled in yeti_web.yml so
# yeti can boot without the doorkeeper migration applied. The `if` wrapper
# (instead of an early `return`) avoids static-analysis warnings about
# top-level returns.
